...
if (class_exists('surat_keputusan_edar_alkes_import_controller')) {
	// do nothing
} else if (defined('CLASS_surat_keputusan_edar_alkes_import_CONTROLLER')) {
	// do nothing
} else {
	define('CLASS_surat_keputusan_edar_alkes_import_CONTROLLER', TRUE);

include_once 'class.surat_keputusan_edar_alkes_import.inc.php';
class surat_keputusan_edar_alkes_import_controller extends depkes2_manager {
	var $surat_keputusan_edar_alkes_import_label;
	var $optional_arr;
	function surat_keputusan_edar_alkes_import_controller() {
		$this->surat_keputusan_edar_alkes_import_label = array (
			'id_surat_keputusan_edar_alkes_import' => 'Id Surat keputusan_edar_alkes_import',
			'no_surat_keputusan_edar_alkes_import' => 'Nomor Surat Keputusan Edar Alkes Import',
		...
		$this->optional_arr = array (
			'id_surat_keputusan_edar_alkes_import' => TRUE,
			'surat_keputusan_edar_alkes_import' => FALSE,
			'keputusan_edar_alkes_import' => FALSE,
			'insert_by' => TRUE,
 ...
 function id_cek_1_form(&$config) {
		...
		$fk_sql = ''.
			...
			LEFT OUTER JOIN surat_penolakan_edar_alkes_import ON( surat_penolakan_edar_alkes_import.id_cek_1 = cek_kelengkapan_data_edar_import.id_cek_1)
			WHERE
			surat_penolakan_edar_alkes_import.id_cek_1 IS NULL AND
			...
			FROM
				cek_kelengkapan_data_edar_import
			LEFT OUTER JOIN surat_keputusan_edar_alkes_import ON(surat_keputusan_edar_alkes_import.id_cek_1 = cek_kelengkapan_data_edar_import.id_cek_1)
			LEFT OUTER JOIN tt_1_edar_alkes_import ON(tt_1_edar_alkes_import.no_tt = cek_kelengkapan_data_edar_import.no_tt)
			LEFT OUTER JOIN pendaftar_edar_alkes_import ON(pendaftar_edar_alkes_import.kode_pendaftar_edar_alkes_import = tt_1_edar_alkes_import.kode_pendaftar_edar_alkes_import)
			LEFT OUTER JOIN surat_penolakan_edar_alkes_import ON( surat_penolakan_edar_alkes_import.id_cek_1 = cek_kelengkapan_data_edar_import.id_cek_1)
			WHERE
			(surat_keputusan_edar_alkes_import.id_cek_1 IS NULL AND surat_penolakan_edar_alkes_import.id_cek_1 IS NULL) AND
			(cek_kelengkapan_data_edar_import.status_direktur = \'0\' OR	cek_kelengkapan_data_edar_import.status_kasubdit = \'0\')
			ORDER BY
				cek_kelengkapan_data_edar_import.date_insert
			';
		...
		$default_value = array(
			array (
				'skey' => '',
				'svalue' => __('No Tanda Terima - ').' '.$this->surat_keputusan_edar_alkes_import_label['id_cek_1']
			)
		);
	...
	// create add surat_keputusan_edar_alkes_import form
	function add_surat_keputusan_edar_alkes_import_form() {
//		if (! $this->get_permission('fill_this')) return $this->intruder();
		global ${$GLOBALS['session_vars']}, ${$GLOBALS['get_vars']};
		$field_arr = surat_keputusan_edar_alkes_import::get_field_set();

//		$value_arr = array ();
		$label_arr = $this->surat_keputusan_edar_alkes_import_label;
		$optional_arr = $this->optional_arr;
		$optional_arr['keputusan_edar_alkes_import'] = 'user_defined';
		$value_arr['keputusan_edar_alkes_import']= '<textarea rows="100" cols="75" name="keputusan_edar_alkes_import" class="text"></textarea>';
...
//		$label_arr['submit_val'] = 'Submit';
		...
		$label_arr['form_title'] = __('Form').' '.__('Add').' Surat keputusan Izin Edar Alkes Import'; // default null
	...
	// create update surat_keputusan_edar_alkes_import form
	function update_surat_keputusan_edar_alkes_import_form() {
//		if (! $this->get_permission('fill_this')) return $this->intruder();
		global ${$GLOBALS['session_vars']}, ${$GLOBALS['get_vars']};
		$field_arr = surat_keputusan_edar_alkes_import::get_field_set();

		$optional_arr = $this->optional_arr;
		$optional_arr['id_surat_keputusan_edar_alkes_import'] = 'protect';
		$record = array (
			'id_surat_keputusan_edar_alkes_import' => ${$GLOBALS['get_vars']}['id_surat_keputusan_edar_alkes_import']
		);
		$result = surat_keputusan_edar_alkes_import::get($record);
		$value_arr = $result[0];
		$label_arr = $this->surat_keputusan_edar_alkes_import_label;
		...
		$this->id_cek_1_form($config);
		$optional_arr['keputusan_edar_alkes_import'] = 'user_defined';
		$value_arr['keputusan_edar_alkes_import']= '<textarea rows="100" cols="75" name="keputusan_edar_alkes_import" class="text">'.$value_arr['keputusan_edar_alkes_import'].'</textarea>';
//		$label_arr['submit_val'] = 'Submit';
		$label_arr['form_extra'] = '<input type=hidden name=action value=postedit>'; // default null
		$label_arr['form_title'] = ('Update Surat keputusan Izin Edar Alkes Import Form'); // default null
		$label_arr['form_width'] = '100%'; // default 100%
		$label_arr['form_name'] = 'theform'; // default form
	...
	// create import surat_keputusan_edar_alkes_import form
...
//		if (! $this->get_permission('fill_this')) return $this->intruder();
	...
	// handle event add surat_keputusan_edar_alkes_import
	function add_surat_keputusan_edar_alkes_import() {
//		if (! $this->get_permission('fill_this')) return $this->intruder();
		global ${$GLOBALS['post_vars']};
		$record = array (
			'no_surat_keputusan_edar_alkes_import' => ${$GLOBALS['post_vars']}['no_surat_keputusan_edar_alkes_import'],
		...
		$_block = new block();
		$_block->set_config('title', __('Status').' '.__('Add').' Surat keputusan Izin Edar Alkes Import');
		$_block->set_config('width', 595);
		if (! surat_keputusan_edar_alkes_import::get($record)) {
			eval($this->save_config);
			if (surat_keputusan_edar_alkes_import::add($record)) {
				...
				if ($GLOBALS[$GLOBALS['post_vars']]['opener']) {
					...
					if (! $record[$opener_var]) {
						if (eregi('postgre', $GLOBALS['adodb_type']))
							...
							"SELECT
								currval('surat_keputusan_edar_alkes_import_{$opener_var}_seq') AS last_id
							FROM
								surat_keputusan_edar_alkes_import"
							);
...
EOT;
	...
	// handle event update surat_keputusan_edar_alkes_import
	function update_surat_keputusan_edar_alkes_import() {
//		if (! $this->get_permission('fill_this')) return $this->intruder();
		global ${$GLOBALS['post_vars']};
		$record = array (
			'id_surat_keputusan_edar_alkes_import' => ${$GLOBALS['post_vars']}['id_surat_keputusan_edar_alkes_import']
		);
		$_block = new block();
		$_block->set_config('title', ('Update Surat keputusan Izin Edar Alkes Import Status'));
		$_block->set_config('width', 595);
		if ($result = surat_keputusan_edar_alkes_import::get($record)) {
			$record = $result[0];
			if (${$GLOBALS['post_vars']}['surat_keputusan_edar_alkes_import']!='') $record['surat_keputusan_edar_alkes_import'] = ${$GLOBALS['post_vars']}['surat_keputusan_edar_alkes_import'];
			if (${$GLOBALS['post_vars']}['keputusan_edar_alkes_import']!='') $record['keputusan_edar_alkes_import'] = ${$GLOBALS['post_vars']}['keputusan_edar_alkes_import'];
			...
			eval($this->save_config);
			if (surat_keputusan_edar_alkes_import::update($record)) {
	...
	// handle delete surat_keputusan_edar_alkes_import
	function delete_surat_keputusan_edar_alkes_import() {
//		if (! $this->get_permission('fill_this')) return $this->intruder();
		...
		if ($query)
			$success = $adodb->Execute("delete from surat_keputusan_edar_alkes_import where ".$query);

		$_block = new block();
		$_block->set_config('title', ('Delete Surat keputusan Izin Edar Alkes Import Status'));
		$_block->set_config('width', 595);
				$info[] = ('+surat_keputusan_edar_alkes_import <font color=red>'.$query.'</font> <font color=green><b>'.__('Successfull Deleted').'</b></font>');
//				$adodb->Execute('delete from fill_this where '.$query3);
	...
	function view_surat_keputusan_edar_alkes_import_form() {
//		if (! $this->get_permission('fill_this')) return $this->intruder();
		...
		$sqlA = "SELECT
		no_surat_keputusan_edar_alkes_import,
		id_cek_1
		FROM
		surat_keputusan_edar_alkes_import
		WHERE
		id_surat_keputusan_edar_alkes_import ='".$value_arr['id_surat_keputusan_edar_alkes_import']."'
		";

		$hasil=$adodb->Execute($sqlA);
		WHILE(! $hasil->EOF){
			$no_surat_keputusan_edar_alkes_import = $hasil->fields['no_surat_keputusan_edar_alkes_import'];
		...
		$sqlB="
		select
		surat_keputusan_edar_alkes_import.id_surat_keputusan_edar_alkes_import,
		surat_keputusan_edar_alkes_import.no_surat_keputusan_edar_alkes_import,
		surat_keputusan_edar_alkes_import.nama,
		surat_keputusan_edar_alkes_import.nip,
		pendaftar_edar_alkes_import.nama_pendaftar_edar_alkes_import,
		pendaftar_edar_alkes_import.nama_pabrik,
		pendaftar_edar_alkes_import.npwp,
		pendaftar_edar_alkes_import.alamat_pendaftar_edar_alkes_import,
		pendaftar_edar_alkes_import.namapenanggungjwb,
		pendaftar_edar_alkes_import.alamatgudang,
		pendaftar_edar_alkes_import.alamat_bengkel,
		pendaftar_edar_alkes_import.alamat_pabrik,
		pendaftar_edar_alkes_import.nama_propinsi_1,
		pendaftar_edar_alkes_import.nama_propinsi_2,
		pendaftar_edar_alkes_import.nama_direktur,
		gol_alkes.golongan,
		tt_1_edar_alkes_import.urut_no_tt,
		tt_1_edar_alkes_import.kode_subdit,
		...
		from
		surat_keputusan_edar_alkes_import
		LEFT OUTER JOIN cek_kelengkapan_data_edar_import ON(cek_kelengkapan_data_edar_import.id_cek_1 = surat_keputusan_edar_alkes_import.id_cek_1)
		LEFT OUTER JOIN tt_1_edar_alkes_import ON(tt_1_edar_alkes_import.no_tt = cek_kelengkapan_data_edar_import.no_tt)
		LEFT OUTER JOIN pendaftar_edar_alkes_import ON(pendaftar_edar_alkes_import.kode_pendaftar_edar_alkes_import = tt_1_edar_alkes_import.kode_pendaftar_edar_alkes_import)
		LEFT OUTER JOIN gol_alkes ON(gol_alkes.id_golongan = cek_kelengkapan_data_edar_import.id_golongan)
		...
		WHERE
		surat_keputusan_edar_alkes_import.id_cek_1 = '".$id_cek_1."'
		";
		//print $sqlB;
		$rsb = $adodb->Execute($sqlB);
		$golongan = $rsb->fields['golongan'];
		$nama_produk = $rsb->fields['nama_produk'];
		$no_surat_keputusan_edar_alkes_import = $rsb->fields['no_surat_keputusan_edar_alkes_import'];
		...
		$nama_pendaftar_edar_alkes_import = $rsb->fields['nama_pendaftar_edar_alkes_import'];
		...
		$pdf->Ln(10);
		$pdf->Cell(180,7,''.$no_surat_keputusan_edar_alkes_import.'','',0,'C');
		$pdf->Ln(5);
		$pdf->SetFont('Arial','',12);
		$pdf->Ln();
		...
		$pdf->Ln();
		$pdf->Cell(20,7,'','',0,'L');$pdf->Cell(45,7,'Nama Pendaftar','',0,'L');$pdf->Cell(5,7,' : ','',0,'L');$pdf->Cell(110,7,''.$nama_pendaftar_edar_alkes_import.'','',0,'L');
		$pdf->Ln();
	...
	// handle event import surat_keputusan_edar_alkes_import
	function import_surat_keputusan_edar_alkes_import() {
//		if (! $this->get_permission('fill_this')) return $this->intruder();
		...
		global $adodb;
		if ($delete_where) $delete_query = "DELETE FROM surat_keputusan_edar_alkes_import WHERE ".$delete_where." ;";
		...
		if ($insert_key && $insert_value) {
			...
			if (strstr($GLOBALS['adodb_type'], 'mysql')) {
				...
				fwrite($fl, $data_file);
				fclose($fl);
				$adodb->Execute('LOAD DATA INFILE \''.$output_file.'.mysql'.'\' INTO TABLE surat_keputusan_edar_alkes_import '.$insert_key);
				...
				fwrite($fl, $data_file);
				fclose($fl);
				$adodb->Execute('COPY surat_keputusan_edar_alkes_import '.$insert_key.' FROM \''.$output_file.'.pgsql'.'\'');
				unlink($output_file.'.pgsql');
			} else {
				$piece = explode("\n", $all_query);
				foreach ($piece as $key => $value) {
					$adodb->Execute('INSERT INTO surat_keputusan_edar_alkes_import '.$insert_key.' VALUES '.$value);
				}
			}
		}

		$_block = new block();
		$_block->set_config('title', ('Import surat_keputusan_edar_alkes_import Izin Produksi Status'));
		$_block->set_config('width', 595);
		if (! $adodb->ErrorMsg()) {
	...
	// handle list surat_keputusan_edar_alkes_import
	function list_surat_keputusan_edar_alkes_import($extra_config='') {
//		if (! $this->get_permission('fill_this')) return $this->intruder();
		...
		$vsel_arr = array (
			'id_surat_keputusan_edar_alkes_import' => TRUE,
			'surat_keputusan_edar_alkes_import' => TRUE,
			'insert_by' => FALSE,
			'date_insert' => FALSE
		);
		$eval_arr = array ();
...
//		if ($this->get_permission('fill_this')) {
			...
			'?action=add' .
			'\', 600, 400, null, null, \'add_surat_keputusan_edar_alkes_import\');'.
			'win.focus()',
			"title"=>__("Add").'Surat keputusan Izin Edar Alkes Import',
			"label"=>__("Add"),
...
//				'?action=import' .
//				'\', 600, 400, null, null, \'import_surat_keputusan_edar_alkes_import\');', "title"=>__("Import").' surat_keputusan_edar_alkes_import"', "label"=>__('(I)')));
//			}
//		}
//		if ($this->get_permission('fill_this')) {
			$edit_anchor = pager::pager_button(array("link"=>'javascript:'.
			'win=openIT(\'' . $GLOBALS['PHP_SELF'] .
			'?action=edit%s\', 600, 400, null, null, \'edit_surat_keputusan_edar_alkes_import\');'.
			'win.focus()',
			"title"=>__("Edit").' Surat keputusan Izin Edar Alkes Import',
			"label"=>__('Edit'),
...
//		if ($this->get_permission('fill_this')) {
			...
			__('Confirm Delete').'?\')?(' . 
			'win=openIT(\'' . $GLOBALS['PHP_SELF'] .
			'?action=del%s\', 600, 400, null, null, \'del_surat_keputusan_edar_alkes_import\')'.
			'win.focus()):' . 
			'alert(\''.__('Cancelling Delete').'\');', 
			"title"=>__('Delete').' Surat keputusan Izin Edar Alkes Import', 
			"label"=>__('Delete'),
...
//		}
			...
			'win.focus()',
			"title"=>__("View").' Surat keputusan Izin Edar Alkes Import',
			"label"=>__('View'),
...
//		}
		...
		$print_anchor = pager::pager_button(array(
			...
			'?action=print\''.
			', 600, 400, null, null, \'print_surat_keputusan_edar_alkes_import\');'.
			'win.focus()',
			"title"=>__('Print').' Surat keputusan Izin Edar Alkes Import',
			"label"=>__('Print'),
			"type"=>"button",
		...
		$label_arr = $this->surat_keputusan_edar_alkes_import_label;
		$config = array (
			'id'		=> 'surat_keputusan_edar_alkes_import',
			'db'		=> &$GLOBALS['adodb'],
			'optional_arr'	=> $optional_arr,
			'label_arr'	=> $label_arr,
			'vsel_arr'	=> $vsel_arr,
			...
			'pk'		=> $pk,
			'form_width'	=> 595,
			'form_title'	=> __('List').' Surat keputusan Izin Edar Alkes Import'.' - '.date($GLOBALS['date_format']));
		if (is_array($extra_config)) $config = array_merge($config, $extra_config);
		$_pager = new pager($config);
		return $_pager->render();
	}

	// handle print surat_keputusan_edar_alkes_import
	function print_surat_keputusan_edar_alkes_import() {
		$config['header_view'] = FALSE;
		$config['add_anchor'] = FALSE;
		$config['del_anchor'] = FALSE;
		$config['edit_anchor'] = FALSE;
		return $this->list_surat_keputusan_edar_alkes_import($config);
	}
}
...
if (! $GLOBALS['_CONTROLLED']) {
	...
	$surat_keputusan_edar_alkes_import_controller = new surat_keputusan_edar_alkes_import_controller();
	$action = ${$GLOBALS['post_vars']}['action'] ? ${$GLOBALS['post_vars']}['action'] : ${$GLOBALS['get_vars']}['action'];
	switch ($action) {
		case 'add':
			$out_extra_body =  'onLoad="DocumentLoad()"';
			$out_content = $surat_keputusan_edar_alkes_import_controller->add_surat_keputusan_edar_alkes_import_form();
			$out_content .= $back_to_menu;
			break;
		case 'postadd':
			$out_content = $surat_keputusan_edar_alkes_import_controller->add_surat_keputusan_edar_alkes_import();
			$out_content .= $self_close_js;
			$out_content .= $back_to_menu;
			break;
		case 'edit':
			$out_extra_body =  'onLoad="DocumentLoad()"';
			$out_content = $surat_keputusan_edar_alkes_import_controller->update_surat_keputusan_edar_alkes_import_form();
			$out_content .= $back_to_menu;
			break;
		case 'postedit':
			$out_content = $surat_keputusan_edar_alkes_import_controller->update_surat_keputusan_edar_alkes_import();
			$out_content .= $self_close_js;
			$out_content .= $back_to_menu;
			break;
		case 'view':
		    	$out_extra_body =  'onLoad="DocumentLoad()"';
		    	$out_content = $surat_keputusan_edar_alkes_import_controller->view_surat_keputusan_edar_alkes_import_form();
			$out_content .= $back_to_menu;
			echo $out_content;
			exit;
			break;
		case 'del':
			$out_content = $surat_keputusan_edar_alkes_import_controller->delete_surat_keputusan_edar_alkes_import();
			$out_content .= $self_close_js;
			$out_content .= $back_to_menu;
			break;
		case 'import':
			$out_extra_body =  'onLoad="DocumentLoad()"';
			$out_content = $surat_keputusan_edar_alkes_import_controller->import_surat_keputusan_edar_alkes_import_form();
			$out_content .= $back_to_menu;
			break;
		case 'postimport':
			$out_content = $surat_keputusan_edar_alkes_import_controller->import_surat_keputusan_edar_alkes_import();
			$out_content .= $self_close_js;
			$out_content .= $back_to_menu;
			break;
		case 'print':
			$out_content = $surat_keputusan_edar_alkes_import_controller->print_surat_keputusan_edar_alkes_import();
			$out_extra_body = 'onLoad=top.window.print()';
			break;
		case 'find':
		default:
			$out_content = $surat_keputusan_edar_alkes_import_controller->list_surat_keputusan_edar_alkes_import();
			include 'depkes2_menu.php';
			exit;
			break;
	}

	$_title = 'Surat keputusan Izin Edar Alkes Import Administration';
