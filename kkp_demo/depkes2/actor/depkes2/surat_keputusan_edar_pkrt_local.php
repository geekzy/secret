...
if (class_exists('surat_keputusan_edar_pkrt_local_controller')) {
	// do nothing
} else if (defined('CLASS_surat_keputusan_edar_pkrt_local_CONTROLLER')) {
	// do nothing
} else {
	define('CLASS_surat_keputusan_edar_pkrt_local_CONTROLLER', TRUE);

include_once 'class.surat_keputusan_edar_pkrt_local.inc.php';
class surat_keputusan_edar_pkrt_local_controller extends depkes2_manager {
	var $surat_keputusan_edar_pkrt_local_label;
	var $optional_arr;
	function surat_keputusan_edar_pkrt_local_controller() {
		$this->surat_keputusan_edar_pkrt_local_label = array (
			'id_surat_keputusan_edar_pkrt_local' => 'Id Surat keputusan_edar_pkrt_local',
			'no_surat_keputusan_edar_pkrt_local' => 'Nomor Surat Keputusan Edar pkrt local',
		...
		$this->optional_arr = array (
			'id_surat_keputusan_edar_pkrt_local' => TRUE,
			'surat_keputusan_edar_pkrt_local' => FALSE,
			'keputusan_edar_pkrt_local' => FALSE,
			'insert_by' => TRUE,
 ...
 function id_cek_1_form(&$config) {
		...
		$fk_sql = ''.
			...
			LEFT OUTER JOIN tt_1_edar_pkrt_local ON(tt_1_edar_pkrt_local.no_tt = cek_kelengkapan_data_edar_local.no_tt)
			...
			LEFT OUTER JOIN surat_penolakan_edar_pkrt_local ON( surat_penolakan_edar_pkrt_local.id_cek_1 = cek_kelengkapan_data_edar_local.id_cek_1)
			WHERE
			surat_penolakan_edar_pkrt_local.id_cek_1 IS NULL AND
			...
			FROM
				cek_kelengkapan_data_edar_local
			LEFT OUTER JOIN surat_keputusan_edar_pkrt_local ON(surat_keputusan_edar_pkrt_local.id_cek_1 = cek_kelengkapan_data_edar_local.id_cek_1)
			LEFT OUTER JOIN tt_1_edar_pkrt_local ON(tt_1_edar_pkrt_local.no_tt = cek_kelengkapan_data_edar_local.no_tt)
			LEFT OUTER JOIN pendaftar_edar_pkrt_local ON(pendaftar_edar_pkrt_local.kode_pendaftar_edar_pkrt_local = tt_1_edar_pkrt_local.kode_pendaftar_edar_pkrt_local)
			LEFT OUTER JOIN surat_penolakan_edar_pkrt_local ON( surat_penolakan_edar_pkrt_local.id_cek_1 = cek_kelengkapan_data_edar_local.id_cek_1)
			WHERE
			(surat_keputusan_edar_pkrt_local.id_cek_1 IS NULL AND surat_penolakan_edar_pkrt_local.id_cek_1 IS NULL) AND
			(cek_kelengkapan_data_edar_local.status_direktur = \'0\' OR	cek_kelengkapan_data_edar_local.status_kasubdit = \'0\')
			ORDER BY
				cek_kelengkapan_data_edar_local.date_insert
			';
		...
		$default_value = array(
			array (
				'skey' => '',
				'svalue' => __('No Tanda Terima - ').' '.$this->surat_keputusan_edar_pkrt_local_label['id_cek_1']
			)
		);
	...
	// create add surat_keputusan_edar_pkrt_local form
	function add_surat_keputusan_edar_pkrt_local_form() {
//		if (! $this->get_permission('fill_this')) return $this->intruder();
		global ${$GLOBALS['session_vars']}, ${$GLOBALS['get_vars']};
		$field_arr = surat_keputusan_edar_pkrt_local::get_field_set();

//		$value_arr = array ();
		$label_arr = $this->surat_keputusan_edar_pkrt_local_label;
		$optional_arr = $this->optional_arr;
		$optional_arr['keputusan_edar_pkrt_local'] = 'user_defined';
		$value_arr['keputusan_edar_pkrt_local']= '<textarea rows="100" cols="75" name="keputusan_edar_pkrt_local" class="text"></textarea>';
...
//		$label_arr['submit_val'] = 'Submit';
		...
		$label_arr['form_title'] = __('Form').' '.__('Add').' Surat keputusan Izin Edar PKRT Lokal'; // default null
	...
	// create update surat_keputusan_edar_pkrt_local form
	function update_surat_keputusan_edar_pkrt_local_form() {
//		if (! $this->get_permission('fill_this')) return $this->intruder();
		global ${$GLOBALS['session_vars']}, ${$GLOBALS['get_vars']};
		$field_arr = surat_keputusan_edar_pkrt_local::get_field_set();

		$optional_arr = $this->optional_arr;
		$optional_arr['id_surat_keputusan_edar_pkrt_local'] = 'protect';
		$record = array (
			'id_surat_keputusan_edar_pkrt_local' => ${$GLOBALS['get_vars']}['id_surat_keputusan_edar_pkrt_local']
		);
		$result = surat_keputusan_edar_pkrt_local::get($record);
		$value_arr = $result[0];
		$label_arr = $this->surat_keputusan_edar_pkrt_local_label;
		...
		$this->id_cek_1_form($config);
		$optional_arr['keputusan_edar_pkrt_local'] = 'user_defined';
		$value_arr['keputusan_edar_pkrt_local']= '<textarea rows="100" cols="75" name="keputusan_edar_pkrt_local" class="text">'.$value_arr['keputusan_edar_pkrt_local'].'</textarea>';
//		$label_arr['submit_val'] = 'Submit';
		$label_arr['form_extra'] = '<input type=hidden name=action value=postedit>'; // default null
		$label_arr['form_title'] = ('Update Surat keputusan Izin Edar PKRT Lokal Form'); // default null
		$label_arr['form_width'] = '100%'; // default 100%
		$label_arr['form_name'] = 'theform'; // default form
	...
	// create local surat_keputusan_edar_pkrt_local form
	function local_surat_keputusan_edar_pkrt_local_form() {
//		if (! $this->get_permission('fill_this')) return $this->intruder();
		global ${$GLOBALS['session_vars']}, ${$GLOBALS['get_vars']};
		...
		$label_arr['form_title'] = ('local Surat keputusan Izin Edar PKRT Lokal Form'); // default null
		$label_arr['form_width'] = '100%'; // default 100%
		$label_arr['form_name'] = 'theform'; // default form
	...
	// handle event add surat_keputusan_edar_pkrt_local
	function add_surat_keputusan_edar_pkrt_local() {
//		if (! $this->get_permission('fill_this')) return $this->intruder();
		global ${$GLOBALS['post_vars']};
		$record = array (
			'no_surat_keputusan_edar_pkrt_local' => ${$GLOBALS['post_vars']}['no_surat_keputusan_edar_pkrt_local'],
		...
		$_block = new block();
		$_block->set_config('title', __('Status').' '.__('Add').' Surat keputusan Izin Edar PKRT Lokal');
		$_block->set_config('width', 595);
		if (! surat_keputusan_edar_pkrt_local::get($record)) {
			eval($this->save_config);
			if (surat_keputusan_edar_pkrt_local::add($record)) {
				...
				if ($GLOBALS[$GLOBALS['post_vars']]['opener']) {
					...
					if (! $record[$opener_var]) {
						if (eregi('postgre', $GLOBALS['adodb_type']))
							...
							"SELECT
								currval('surat_keputusan_edar_pkrt_local_{$opener_var}_seq') AS last_id
							FROM
								surat_keputusan_edar_pkrt_local"
							);
...
EOT;
	...
	// handle event update surat_keputusan_edar_pkrt_local
	function update_surat_keputusan_edar_pkrt_local() {
//		if (! $this->get_permission('fill_this')) return $this->intruder();
		global ${$GLOBALS['post_vars']};
		$record = array (
			'id_surat_keputusan_edar_pkrt_local' => ${$GLOBALS['post_vars']}['id_surat_keputusan_edar_pkrt_local']
		);
		$_block = new block();
		$_block->set_config('title', ('Update Surat keputusan Izin Edar PKRT Lokal Status'));
		$_block->set_config('width', 595);
		if ($result = surat_keputusan_edar_pkrt_local::get($record)) {
			$record = $result[0];
			if (${$GLOBALS['post_vars']}['surat_keputusan_edar_pkrt_local']!='') $record['surat_keputusan_edar_pkrt_local'] = ${$GLOBALS['post_vars']}['surat_keputusan_edar_pkrt_local'];
			if (${$GLOBALS['post_vars']}['keputusan_edar_pkrt_local']!='') $record['keputusan_edar_pkrt_local'] = ${$GLOBALS['post_vars']}['keputusan_edar_pkrt_local'];
			...
			eval($this->save_config);
			if (surat_keputusan_edar_pkrt_local::update($record)) {
	...
	// handle delete surat_keputusan_edar_pkrt_local
	function delete_surat_keputusan_edar_pkrt_local() {
//		if (! $this->get_permission('fill_this')) return $this->intruder();
		...
		if ($query)
			$success = $adodb->Execute("delete from surat_keputusan_edar_pkrt_local where ".$query);

		$_block = new block();
		$_block->set_config('title', ('Delete Surat keputusan Izin Edar PKRT Lokal Status'));
		$_block->set_config('width', 595);
				$info[] = ('+surat_keputusan_edar_pkrt_local <font color=red>'.$query.'</font> <font color=green><b>'.__('Successfull Deleted').'</b></font>');
//				$adodb->Execute('delete from fill_this where '.$query3);
	...
	function view_surat_keputusan_edar_pkrt_local_form() {
//		if (! $this->get_permission('fill_this')) return $this->intruder();
		...
		$sqlA = "SELECT
		no_surat_keputusan_edar_pkrt_local,
		id_cek_1
		FROM
		surat_keputusan_edar_pkrt_local
		WHERE
		id_surat_keputusan_edar_pkrt_local ='".$value_arr['id_surat_keputusan_edar_pkrt_local']."'
		";

		$hasil=$adodb->Execute($sqlA);
		WHILE(! $hasil->EOF){
			$no_surat_keputusan_edar_pkrt_local = $hasil->fields['no_surat_keputusan_edar_pkrt_local'];
		...
		$sqlB="
		select
		surat_keputusan_edar_pkrt_local.id_surat_keputusan_edar_pkrt_local,
		surat_keputusan_edar_pkrt_local.no_surat_keputusan_edar_pkrt_local,
		surat_keputusan_edar_pkrt_local.nama,
		surat_keputusan_edar_pkrt_local.nip,
		...
		tt_1_edar_pkrt_local.kode_subdit,
		...
		from
		surat_keputusan_edar_pkrt_local
		LEFT OUTER JOIN cek_kelengkapan_data_edar_local ON(cek_kelengkapan_data_edar_local.id_cek_1 = surat_keputusan_edar_pkrt_local.id_cek_1)
		LEFT OUTER JOIN tt_1_edar_pkrt_local ON(tt_1_edar_pkrt_local.no_tt = cek_kelengkapan_data_edar_local.no_tt)
		LEFT OUTER JOIN pendaftar_edar_pkrt_local ON(pendaftar_edar_pkrt_local.kode_pendaftar_edar_pkrt_local = tt_1_edar_pkrt_local.kode_pendaftar_edar_pkrt_local)
		LEFT OUTER JOIN gol_pkrt ON(gol_pkrt.id_golongan = cek_kelengkapan_data_edar_local.id_golongan)
		...
		WHERE
		surat_keputusan_edar_pkrt_local.id_cek_1 = '".$id_cek_1."'
		";
		//print $sqlB;
		$rsb = $adodb->Execute($sqlB);
		$golongan = $rsb->fields['golongan'];
		$nama_produk = $rsb->fields['nama_produk'];
		$no_surat_keputusan_edar_pkrt_local = $rsb->fields['no_surat_keputusan_edar_pkrt_local'];
		...
		$nama_pendaftar_edar_pkrt_local = $rsb->fields['nama_pendaftar_edar_pkrt_local'];
		...
		$pdf->Ln(10);
		$pdf->Cell(180,7,''.$no_surat_keputusan_edar_pkrt_local.'','',0,'C');
		$pdf->Ln(5);
		$pdf->SetFont('Arial','',12);
		$pdf->Ln();
		...
		$pdf->Ln();
		$pdf->Cell(20,7,'','',0,'L');$pdf->Cell(45,7,'Nama Pendaftar','',0,'L');$pdf->Cell(5,7,' : ','',0,'L');$pdf->Cell(110,7,''.$nama_pendaftar_edar_pkrt_local.'','',0,'L');
		$pdf->Ln();
	...
	// handle event local surat_keputusan_edar_pkrt_local
	function local_surat_keputusan_edar_pkrt_local() {
//		if (! $this->get_permission('fill_this')) return $this->intruder();
		...
		global $adodb;
		if ($delete_where) $delete_query = "DELETE FROM surat_keputusan_edar_pkrt_local WHERE ".$delete_where." ;";
		...
		if ($insert_key && $insert_value) {
			...
			if (strstr($GLOBALS['adodb_type'], 'mysql')) {
				...
				fwrite($fl, $data_file);
				fclose($fl);
				$adodb->Execute('LOAD DATA INFILE \''.$output_file.'.mysql'.'\' INTO TABLE surat_keputusan_edar_pkrt_local '.$insert_key);
				...
				fwrite($fl, $data_file);
				fclose($fl);
				$adodb->Execute('COPY surat_keputusan_edar_pkrt_local '.$insert_key.' FROM \''.$output_file.'.pgsql'.'\'');
				unlink($output_file.'.pgsql');
			} else {
				$piece = explode("\n", $all_query);
				foreach ($piece as $key => $value) {
					$adodb->Execute('INSERT INTO surat_keputusan_edar_pkrt_local '.$insert_key.' VALUES '.$value);
				}
			}
		}

		$_block = new block();
		$_block->set_config('title', ('local surat_keputusan_edar_pkrt_local Izin Produksi Status'));
		$_block->set_config('width', 595);
		if (! $adodb->ErrorMsg()) {
	...
	// handle list surat_keputusan_edar_pkrt_local
	function list_surat_keputusan_edar_pkrt_local($extra_config='') {
//		if (! $this->get_permission('fill_this')) return $this->intruder();
		...
		$vsel_arr = array (
			'id_surat_keputusan_edar_pkrt_local' => TRUE,
			'surat_keputusan_edar_pkrt_local' => TRUE,
			'insert_by' => FALSE,
			'date_insert' => FALSE
		);
		$eval_arr = array ();
...
//		if ($this->get_permission('fill_this')) {
			...
			'?action=add' .
			'\', 600, 400, null, null, \'add_surat_keputusan_edar_pkrt_local\');'.
			'win.focus()',
			"title"=>__("Add").'Surat keputusan Izin Edar PKRT Lokal',
			"label"=>__("Add"),
...
//				'?action=local' .
//				'\', 600, 400, null, null, \'local_surat_keputusan_edar_pkrt_local\');', "title"=>__("local").' surat_keputusan_edar_pkrt_local"', "label"=>__('(I)')));
//			}
//		}
//		if ($this->get_permission('fill_this')) {
			$edit_anchor = pager::pager_button(array("link"=>'javascript:'.
			'win=openIT(\'' . $GLOBALS['PHP_SELF'] .
			'?action=edit%s\', 600, 400, null, null, \'edit_surat_keputusan_edar_pkrt_local\');'.
			'win.focus()',
			"title"=>__("Edit").' Surat keputusan Izin Edar PKRT Lokal',
			"label"=>__('Edit'),
...
//		if ($this->get_permission('fill_this')) {
			...
			__('Confirm Delete').'?\')?(' . 
			'win=openIT(\'' . $GLOBALS['PHP_SELF'] .
			'?action=del%s\', 600, 400, null, null, \'del_surat_keputusan_edar_pkrt_local\')'.
			'win.focus()):' . 
			'alert(\''.__('Cancelling Delete').'\');', 
			"title"=>__('Delete').' Surat keputusan Izin Edar PKRT Lokal', 
			"label"=>__('Delete'),
...
//		}
			...
			'win.focus()',
			"title"=>__("View").' Surat keputusan Izin Edar PKRT Lokal',
			"label"=>__('View'),
...
//		}
		...
		$print_anchor = pager::pager_button(array(
			...
			'?action=print\''.
			', 600, 400, null, null, \'print_surat_keputusan_edar_pkrt_local\');'.
			'win.focus()',
			"title"=>__('Print').' Surat keputusan Izin Edar PKRT Lokal',
			"label"=>__('Print'),
			"type"=>"button",
		...
		$label_arr = $this->surat_keputusan_edar_pkrt_local_label;
		$config = array (
			'id'		=> 'surat_keputusan_edar_pkrt_local',
			'db'		=> &$GLOBALS['adodb'],
			'optional_arr'	=> $optional_arr,
			'label_arr'	=> $label_arr,
			'vsel_arr'	=> $vsel_arr,
			...
			'pk'		=> $pk,
			'form_width'	=> 595,
			'form_title'	=> __('List').' Surat keputusan Izin Edar PKRT Lokal'.' - '.date($GLOBALS['date_format']));
		if (is_array($extra_config)) $config = array_merge($config, $extra_config);
		$_pager = new pager($config);
		return $_pager->render();
	}

	// handle print surat_keputusan_edar_pkrt_local
	function print_surat_keputusan_edar_pkrt_local() {
		$config['header_view'] = FALSE;
		$config['add_anchor'] = FALSE;
		$config['del_anchor'] = FALSE;
		$config['edit_anchor'] = FALSE;
		return $this->list_surat_keputusan_edar_pkrt_local($config);
	}
}
...
if (! $GLOBALS['_CONTROLLED']) {
	...
	$surat_keputusan_edar_pkrt_local_controller = new surat_keputusan_edar_pkrt_local_controller();
	$action = ${$GLOBALS['post_vars']}['action'] ? ${$GLOBALS['post_vars']}['action'] : ${$GLOBALS['get_vars']}['action'];
	switch ($action) {
		case 'add':
			$out_extra_body =  'onLoad="DocumentLoad()"';
			$out_content = $surat_keputusan_edar_pkrt_local_controller->add_surat_keputusan_edar_pkrt_local_form();
			$out_content .= $back_to_menu;
			break;
		case 'postadd':
			$out_content = $surat_keputusan_edar_pkrt_local_controller->add_surat_keputusan_edar_pkrt_local();
			$out_content .= $self_close_js;
			$out_content .= $back_to_menu;
			break;
		case 'edit':
			$out_extra_body =  'onLoad="DocumentLoad()"';
			$out_content = $surat_keputusan_edar_pkrt_local_controller->update_surat_keputusan_edar_pkrt_local_form();
			$out_content .= $back_to_menu;
			break;
		case 'postedit':
			$out_content = $surat_keputusan_edar_pkrt_local_controller->update_surat_keputusan_edar_pkrt_local();
			$out_content .= $self_close_js;
			$out_content .= $back_to_menu;
			break;
		case 'view':
		    	$out_extra_body =  'onLoad="DocumentLoad()"';
		    	$out_content = $surat_keputusan_edar_pkrt_local_controller->view_surat_keputusan_edar_pkrt_local_form();
			$out_content .= $back_to_menu;
			echo $out_content;
			exit;
			break;
		case 'del':
			$out_content = $surat_keputusan_edar_pkrt_local_controller->delete_surat_keputusan_edar_pkrt_local();
			$out_content .= $self_close_js;
			$out_content .= $back_to_menu;
			break;
		case 'local':
			$out_extra_body =  'onLoad="DocumentLoad()"';
			$out_content = $surat_keputusan_edar_pkrt_local_controller->local_surat_keputusan_edar_pkrt_local_form();
			$out_content .= $back_to_menu;
			break;
		case 'postlocal':
			$out_content = $surat_keputusan_edar_pkrt_local_controller->local_surat_keputusan_edar_pkrt_local();
			$out_content .= $self_close_js;
			$out_content .= $back_to_menu;
			break;
		case 'print':
			$out_content = $surat_keputusan_edar_pkrt_local_controller->print_surat_keputusan_edar_pkrt_local();
			$out_extra_body = 'onLoad=top.window.print()';
			break;
		case 'find':
		default:
			$out_content = $surat_keputusan_edar_pkrt_local_controller->list_surat_keputusan_edar_pkrt_local();
			include 'depkes2_menu.php';
			exit;
			break;
	}

	$_title = 'Surat keputusan Izin Edar PKRT Lokal Administration';
