...
class Workbook extends BIFFwriter
  ...
  function Workbook($filename)
    {
    parent::BIFFwriter(); //hay que llamar explícitamente al constructor del padre
...
/*sub DESTROY {
    ...
    $this->close() if not $this->{_fileclosed};
}*/
...
*/
  function store_workbook()
    ...
    $this->_store_window1();
    $this->_store_1904();
    $this->store_all_fonts();
    $this->store_all_num_formats();
    $this->store_all_xfs();
...
*/
  function store_OLE_file()
    {
    $OLE  = new OLEwriter($this->filename);
...
*/
  function store_all_num_formats()
    {
