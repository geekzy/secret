...
//					$var_name .= '[]';
				...
				if (eregi('(date)|(lda)|(tgl)', $field_arr[$i]['name'])) {
					$date_check = TRUE;
				}
...
/////////////////////////////////////////////////////// END EOT
						...
						if ($int_extra_con_protect) {
							...
							if ($GLOBALS['calendar_js']) {
								...
								$extra_con = '<a href="#" onclick="ppcDF=\''.$date_format.'\';getCalendarFor(document.'.$label_arr['form_name'].'.'.$var_name.');return false"><img src='.$GLOBALS['path_theme'].'/images/calendar.gif align=middle border=0 />'.'</a>';
							}
						} else if ($pass_check) {
							if ($md5_js) {
