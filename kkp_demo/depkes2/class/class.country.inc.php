<?php
  ...
  *  option) any later version.                                              *
  ...
  /* $Id: class.country.inc.php,v 1.1.1.1 2004/06/27 18:34:42 rudi Exp $ */

	// check already defined or not
	if (class_exists('country')) {
		return 0;
	} else if (defined('CLASS_COUNTRY')) {
		return 0;
	} else {
		define('CLASS_COUNTRY', TRUE);
	}
	...
	class country
	{
		...
		function form_select($selected,$name='',$style_class='text')
		{
			if($name=='')
			{
				$name = 'country';
			}
			$str = '<select name="'.$name.'" class="'.$style_class.'">'."\n";
