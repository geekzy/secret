<?php
  ...
  * Inc., 59 Temple Place, Suite 330, Boston, MA  02111-1307  USA            *
  ...
  /* $Id: class.browser.inc.php,v 1.1.1.1 2004/06/27 18:34:42 rudi Exp $ */

if (defined('CLASS_BROWSER')) {
	return 0;
} else {
	define('CLASS_BROWSER', TRUE);
}
	...
	class browser
	{
		...
		function browser()
		{
			...
			$HTTP_USER_AGENT = ${$GLOBALS['server_vars']}['HTTP_USER_AGENT'];
