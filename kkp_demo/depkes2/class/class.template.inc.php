<?php
  ...
  * any later version.                                                       *
  ...
  /* $Id: class.template.inc.php,v 1.1.1.1 2004/06/27 18:34:42 rudi Exp $ */

	if (class_exists('template')) {
		return 0;
	} else if (defined('CLASS_TEMPLATE')) {
		return 0;
	} else {
	...
	class template
	{
		...
		function setFile($handle, $filename = '') {
			return $this->set_file($handle, $filename);
		}
		...
		function setBlock($parent, $handle, $name = '') {
			return $this->set_block($parent, $handle, $name);
		}
		...
		function setVar($varname, $value = '') {
			return $this->set_var($varname, $value);
		}
