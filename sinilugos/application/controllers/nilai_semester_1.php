...
/**
 * Description of nilai_semester_1
 *
 * @author Andi Susilo
 */

class Nilai_semester_1 extends App_Crud_Controller {
    ...
    function _matkul($value) {
        ...
        if (empty($row)) {
            ...
            $this->form_validation->set_message('_matkul', 'Maaf, kode/matkul yang dipilih sudah ada disemester satu ini <br> silahkan pilih kode/matkul yang lain.');
            return FALSE;
        }
    }
    ...
    function _config_grid() {
        ...
        $config['filters'] = array('nilai_semester_1.mahasiswa_nim');
        return $config;
    }
