...
function DftrSek() {
  ...
  $pagefmt = "<a href='?mnux=$mnux&$pref=Sek&SRSEK==PAGE='>=PAGE=</a>";
  $pageoff = "<b>=PAGE=</b>";
  
  $lister = new dwolister;
  $lister->maxrow = 20;
  $lister->pageactive = "=PAGE=";
  $lister->page = $_SESSION['SRSEK']+0;
  $lister->pages = "<a href='?mnux=$mnux&$pref=Sek&SRSEK==PAGE='>=PAGE=</a>";
  $lister->tables = "asalsekolah $_whr
    ...
    $halaman = $lister->TampilkanHalaman();
