...
function ThnPrc() {
  ...
  echo "<p>Sistem akan memproses <font size=+2>$jml</font> data</p>
    <p><IFRAME src='tahun.prc.php?gos=PRC&tahun=$tahun&prodi=$prodi&prid=$prid' frameborder=0>
    </IFRAME></p>
  ";
...
function PrcBipot() {
  ...
  echo "<p>Akan diproses <font size=+1>$n</font> Mahasiswa.</p>
    <p><IFRAME src='tahun.prc.php?gos=PRCBIPOT&tahun=$tahun&prodi=$prodi&prid=$prid' height=200 frameborder=0>
    </IFRAME></p>";
}
...
function PrcTutup() {
  ...
  echo "<p>Akan diproses <font size=+1>$n</font> Mahasiswa.</p>
    <p><IFRAME src='tahun.prc.php?gos=PRCTUTUP&tahun=$tahun&prodi=$prodi&prid=$prid' height=200 frameborder=0>
    </IFRAME></p>";
}
