...
$st_master_kelas = NULL;

//
// Table class for st_master_kelas
//
class cst_master_kelas {
	var $TableVar = 'st_master_kelas';
	...
	//
	function cst_master_kelas() {
		global $Language;
		$this->AllowAddDeleteRow = ew_AllowAddDeleteRow(); // Allow add/delete row

		// kelas
		$this->kelas = new cField('st_master_kelas', 'st_master_kelas', 'x_kelas', 'kelas', '`kelas`', 200, -1, FALSE, '`kelas`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['kelas'] =& $this->kelas;

		// kode_otomatis_tingkat
		$this->kode_otomatis_tingkat = new cField('st_master_kelas', 'st_master_kelas', 'x_kode_otomatis_tingkat', 'kode_otomatis_tingkat', '`kode_otomatis_tingkat`', 200, -1, FALSE, '`kode_otomatis_tingkat`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['kode_otomatis_tingkat'] =& $this->kode_otomatis_tingkat;

		// kode_otomatis
		$this->kode_otomatis = new cField('st_master_kelas', 'st_master_kelas', 'x_kode_otomatis', 'kode_otomatis', '`kode_otomatis`', 200, -1, FALSE, '`kode_otomatis`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function HighlightName() {
		return "st_master_kelas_Highlight";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `st_master_kelas` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `st_master_kelas` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `st_master_kelas` WHERE ";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "st_master_kelaslist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("st_master_kelasview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "st_master_kelasadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("st_master_kelasedit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("st_master_kelasadd.php", $this->UrlParm($parm));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("st_master_kelasdelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=st_master_kelas" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
