...
//
// Table class for rekening2
//
class crekening2 {
	var $TableVar = 'rekening2';
	...
	function crekening2() {
		...
		// kodePokok
		$this->kodePokok = new cField('rekening2', 'rekening2', 'x_kodePokok', 'kodePokok', '`kodePokok`', 200, -1, FALSE, '`kodePokok`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['kodePokok'] =& $this->kodePokok;

		// kodeSubSatu
		$this->kodeSubSatu = new cField('rekening2', 'rekening2', 'x_kodeSubSatu', 'kodeSubSatu', '`kodeSubSatu`', 200, -1, FALSE, '`kodeSubSatu`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['kodeSubSatu'] =& $this->kodeSubSatu;

		// kodeSubDua
		$this->kodeSubDua = new cField('rekening2', 'rekening2', 'x_kodeSubDua', 'kodeSubDua', '`kodeSubDua`', 200, -1, FALSE, '`kodeSubDua`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['kodeSubDua'] =& $this->kodeSubDua;

		// kodeSubTiga
		$this->kodeSubTiga = new cField('rekening2', 'rekening2', 'x_kodeSubTiga', 'kodeSubTiga', '`kodeSubTiga`', 200, -1, FALSE, '`kodeSubTiga`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['kodeSubTiga'] =& $this->kodeSubTiga;

		// Norek
		$this->Norek = new cField('rekening2', 'rekening2', 'x_Norek', 'Norek', '`Norek`', 200, -1, FALSE, '`Norek`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Norek'] =& $this->Norek;

		// Keterangan
		$this->Keterangan = new cField('rekening2', 'rekening2', 'x_Keterangan', 'Keterangan', '`Keterangan`', 200, -1, FALSE, '`Keterangan`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Keterangan'] =& $this->Keterangan;

		// D/K
		$this->D2FK = new cField('rekening2', 'rekening2', 'x_D2FK', 'D/K', '`D/K`', 200, -1, FALSE, '`D/K`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['D/K'] =& $this->D2FK;

		// SaldoAwal
		$this->SaldoAwal = new cField('rekening2', 'rekening2', 'x_SaldoAwal', 'SaldoAwal', '`SaldoAwal`', 5, -1, FALSE, '`SaldoAwal`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->SaldoAwal->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['SaldoAwal'] =& $this->SaldoAwal;

		// Saldo
		$this->Saldo = new cField('rekening2', 'rekening2', 'x_Saldo', 'Saldo', '`Saldo`', 5, -1, FALSE, '`Saldo`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Saldo->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Saldo'] =& $this->Saldo;

		// TanggalSaldo
		$this->TanggalSaldo = new cField('rekening2', 'rekening2', 'x_TanggalSaldo', 'TanggalSaldo', '`TanggalSaldo`', 135, 7, FALSE, '`TanggalSaldo`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// target
		$this->target = new cField('rekening2', 'rekening2', 'x_target', 'target', '`target`', 5, -1, FALSE, '`target`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->target->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['target'] =& $this->target;

		// id
		$this->id = new cField('rekening2', 'rekening2', 'x_id', 'id', '`id`', 19, -1, FALSE, '`id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] =& $this->id;

		// debet_kali
		$this->debet_kali = new cField('rekening2', 'rekening2', 'x_debet_kali', 'debet_kali', '`debet_kali`', 16, -1, FALSE, '`debet_kali`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->debet_kali->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['debet_kali'] =& $this->debet_kali;

		// kredit_kali
		$this->kredit_kali = new cField('rekening2', 'rekening2', 'x_kredit_kali', 'kredit_kali', '`kredit_kali`', 16, -1, FALSE, '`kredit_kali`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("rekening2view.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "rekening2add.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("rekening2edit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("rekening2add.php", $this->UrlParm($parm));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("rekening2delete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=rekening2" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
