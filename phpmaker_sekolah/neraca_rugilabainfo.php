...
$neraca_rugilaba = NULL;

//
// Table class for neraca_rugilaba
//
class cneraca_rugilaba {
	var $TableVar = 'neraca_rugilaba';
	...
	//
	function cneraca_rugilaba() {
		global $Language;
		$this->AllowAddDeleteRow = ew_AllowAddDeleteRow(); // Allow add/delete row

		// Norek
		$this->Norek = new cField('neraca_rugilaba', 'neraca_rugilaba', 'x_Norek', 'Norek', '`Norek`', 200, -1, FALSE, '`Norek`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Norek'] =& $this->Norek;

		// Keterangan
		$this->Keterangan = new cField('neraca_rugilaba', 'neraca_rugilaba', 'x_Keterangan', 'Keterangan', '`Keterangan`', 200, -1, FALSE, '`Keterangan`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Keterangan'] =& $this->Keterangan;

		// tanggal
		$this->tanggal = new cField('neraca_rugilaba', 'neraca_rugilaba', 'x_tanggal', 'tanggal', '`tanggal`', 135, 7, FALSE, '`tanggal`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->tanggal->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['tanggal'] =& $this->tanggal;

		// saldo_debet
		$this->saldo_debet = new cField('neraca_rugilaba', 'neraca_rugilaba', 'x_saldo_debet', 'saldo_debet', '`saldo_debet`', 5, -1, FALSE, '`saldo_debet`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->saldo_debet->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['saldo_debet'] =& $this->saldo_debet;

		// saldo_kredit
		$this->saldo_kredit = new cField('neraca_rugilaba', 'neraca_rugilaba', 'x_saldo_kredit', 'saldo_kredit', '`saldo_kredit`', 5, -1, FALSE, '`saldo_kredit`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function HighlightName() {
		return "neraca_rugilaba_Highlight";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `neraca_rugilaba` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `neraca_rugilaba` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `neraca_rugilaba` WHERE ";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "neraca_rugilabalist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("neraca_rugilabaview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "neraca_rugilabaadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("neraca_rugilabaedit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("neraca_rugilabaadd.php", $this->UrlParm($parm));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("neraca_rugilabadelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=neraca_rugilaba" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
