...
//
// Table class for tahap22
//
class ctahap22 {
	var $TableVar = 'tahap22';
	...
	function ctahap22() {
		...
		// id
		$this->id = new cField('tahap22', 'tahap22', 'x_id', 'id', '`id`', 19, -1, FALSE, '`id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] =& $this->id;

		// kodeSubSatu
		$this->kodeSubSatu = new cField('tahap22', 'tahap22', 'x_kodeSubSatu', 'kodeSubSatu', '`kodeSubSatu`', 200, -1, FALSE, '`kodeSubSatu`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `tahap22` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `tahap22` SET ";
		foreach ($rs as $name => $value) {
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("tahap22view.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "tahap22add.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("tahap22edit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("tahap22add.php", $this->UrlParm($parm));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("tahap22delete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=tahap22" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
...
function Row_Inserting($rsold, &$rsnew) { 
		...
		$_SESSION['kode_sub_satu']=$rsnew['kodeSubSatu'];   
		
		$nilai=ew_ExecuteScalar("SELECT namaSubSatu FROM subsaturek WHERE " .
		 "kodePokok='" . $_SESSION["kode_pokok"] . "' AND kodeSubSatu='" . 
		 $rsnew['kodeSubSatu'] . "' "  );
		
		$_SESSION['nama_sub_satu']=$nilai;
		header("Location: tahap3add.php");
