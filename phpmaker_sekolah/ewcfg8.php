...
define("EW_PROJECT_NAME", "phpmaker_sekolah", TRUE); // Project name
define("EW_RANDOM_KEY", 'Dy3yka0atZ1FeChm', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/phpmaker_sekolah.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_DB", 'sekolah', TRUE);
...
// Security
define("EW_ADMIN_USER_NAME", "b", TRUE); // Administrator user name
define("EW_ADMIN_PASSWORD", "b", TRUE); // Administrator password
define("EW_USE_CUSTOM_LOGIN", TRUE, TRUE); // Use custom login

// Dynamic User Level tables
$EW_USER_LEVEL_TABLE_NAME = array();
$EW_USER_LEVEL_TABLE_NAME[] = 'keu_cicilan';
$EW_USER_LEVEL_TABLE_VAR[] = 'keu_cicilan';
$EW_USER_LEVEL_TABLE_NAME[] = 'keu_master_tanggungan';
$EW_USER_LEVEL_TABLE_VAR[] = 'keu_master_tanggungan';
$EW_USER_LEVEL_TABLE_NAME[] = 'keu_tanggungan';
$EW_USER_LEVEL_TABLE_VAR[] = 'keu_tanggungan';
$EW_USER_LEVEL_TABLE_NAME[] = 'list_khs_kolektif2';
$EW_USER_LEVEL_TABLE_VAR[] = 'list_khs_kolektif2';
$EW_USER_LEVEL_TABLE_NAME[] = 'pengguna';
$EW_USER_LEVEL_TABLE_VAR[] = 'pengguna';
$EW_USER_LEVEL_TABLE_NAME[] = 'pokokrek';
$EW_USER_LEVEL_TABLE_VAR[] = 'pokokrek';
$EW_USER_LEVEL_TABLE_NAME[] = 'rekap_kirim';
$EW_USER_LEVEL_TABLE_VAR[] = 'rekap_kirim';
$EW_USER_LEVEL_TABLE_NAME[] = 'rekening2';
$EW_USER_LEVEL_TABLE_VAR[] = 'rekening2';
$EW_USER_LEVEL_TABLE_NAME[] = 'rekeningju';
$EW_USER_LEVEL_TABLE_VAR[] = 'rekeningju';
$EW_USER_LEVEL_TABLE_NAME[] = 'sch_master_lembaga';
$EW_USER_LEVEL_TABLE_VAR[] = 'sch_master_lembaga';
$EW_USER_LEVEL_TABLE_NAME[] = 'setting';
$EW_USER_LEVEL_TABLE_VAR[] = 'setting';
$EW_USER_LEVEL_TABLE_NAME[] = 'st_krs_masal';
$EW_USER_LEVEL_TABLE_VAR[] = 'st_krs_masal';
$EW_USER_LEVEL_TABLE_NAME[] = 'st_master_admin';
$EW_USER_LEVEL_TABLE_VAR[] = 'st_master_admin';
$EW_USER_LEVEL_TABLE_NAME[] = 'st_master_kelas';
$EW_USER_LEVEL_TABLE_VAR[] = 'st_master_kelas';
$EW_USER_LEVEL_TABLE_NAME[] = 'st_master_kelas_dinamik';
$EW_USER_LEVEL_TABLE_VAR[] = 'st_master_kelas_dinamik';
$EW_USER_LEVEL_TABLE_NAME[] = 'st_master_kelas_kelompok';
$EW_USER_LEVEL_TABLE_VAR[] = 'st_master_kelas_kelompok';
$EW_USER_LEVEL_TABLE_NAME[] = 'st_master_komponen_mk';
$EW_USER_LEVEL_TABLE_VAR[] = 'st_master_komponen_mk';
$EW_USER_LEVEL_TABLE_NAME[] = 'st_master_tingkat';
$EW_USER_LEVEL_TABLE_VAR[] = 'st_master_tingkat';
$EW_USER_LEVEL_TABLE_NAME[] = 'st_patokan_nilai';
$EW_USER_LEVEL_TABLE_VAR[] = 'st_patokan_nilai';
$EW_USER_LEVEL_TABLE_NAME[] = 'st_peserta_kelas_kelompok';
$EW_USER_LEVEL_TABLE_VAR[] = 'st_peserta_kelas_kelompok';
$EW_USER_LEVEL_TABLE_NAME[] = 'st_umum';
$EW_USER_LEVEL_TABLE_VAR[] = 'st_umum';
$EW_USER_LEVEL_TABLE_NAME[] = 'st_view_mahasiswa';
$EW_USER_LEVEL_TABLE_VAR[] = 'st_view_mahasiswa';
$EW_USER_LEVEL_TABLE_NAME[] = 'st_view_master_dosen';
$EW_USER_LEVEL_TABLE_VAR[] = 'st_view_master_dosen';
$EW_USER_LEVEL_TABLE_NAME[] = 'subduarek';
$EW_USER_LEVEL_TABLE_VAR[] = 'subduarek';
$EW_USER_LEVEL_TABLE_NAME[] = 'subsaturek';
$EW_USER_LEVEL_TABLE_VAR[] = 'subsaturek';
$EW_USER_LEVEL_TABLE_NAME[] = 'subtigarek';
$EW_USER_LEVEL_TABLE_VAR[] = 'subtigarek';
$EW_USER_LEVEL_TABLE_NAME[] = 'ujian_pengganti_absensi';
$EW_USER_LEVEL_TABLE_VAR[] = 'ujian_pengganti_absensi';
$EW_USER_LEVEL_TABLE_NAME[] = 'st_master_pengajar';
$EW_USER_LEVEL_TABLE_VAR[] = 'st_master_pengajar';
$EW_USER_LEVEL_TABLE_NAME[] = 'master_siswa';
$EW_USER_LEVEL_TABLE_VAR[] = 'master_siswa';
$EW_USER_LEVEL_TABLE_NAME[] = 'master_agama';
$EW_USER_LEVEL_TABLE_VAR[] = 'master_agama';
$EW_USER_LEVEL_TABLE_NAME[] = 'keu_laporan_keuangan';
$EW_USER_LEVEL_TABLE_VAR[] = 'keu_laporan_keuangan';
$EW_USER_LEVEL_TABLE_NAME[] = 'pemilihan_pokok';
$EW_USER_LEVEL_TABLE_VAR[] = 'pemilihan_pokok';
$EW_USER_LEVEL_TABLE_NAME[] = 'tahap22';
$EW_USER_LEVEL_TABLE_VAR[] = 'tahap22';
$EW_USER_LEVEL_TABLE_NAME[] = 'neraca1';
$EW_USER_LEVEL_TABLE_VAR[] = 'neraca1';
$EW_USER_LEVEL_TABLE_NAME[] = 'master_transaksi2';
$EW_USER_LEVEL_TABLE_VAR[] = 'master_transaksi2';
$EW_USER_LEVEL_TABLE_NAME[] = 'neraca_rugilaba';
$EW_USER_LEVEL_TABLE_VAR[] = 'neraca_rugilaba';
$EW_USER_LEVEL_TABLE_NAME[] = 'neraca2';
$EW_USER_LEVEL_TABLE_VAR[] = 'neraca2';
$EW_USER_LEVEL_TABLE_NAME[] = 'saldo_rugilaba';
$EW_USER_LEVEL_TABLE_VAR[] = 'saldo_rugilaba';
$EW_USER_LEVEL_TABLE_NAME[] = 'entri_tanggungan_perkelompok';
$EW_USER_LEVEL_TABLE_VAR[] = 'entri_tanggungan_perkelompok';
$EW_USER_LEVEL_TABLE_NAME[] = 'view_peserta';
$EW_USER_LEVEL_TABLE_VAR[] = 'view_peserta';
$EW_USER_LEVEL_TABLE_NAME[] = 'pemilihan_jenis_biaya';
$EW_USER_LEVEL_TABLE_VAR[] = 'pemilihan_jenis_biaya';
$EW_USER_LEVEL_TABLE_NAME[] = 'lihat_peserta_kelompok';
$EW_USER_LEVEL_TABLE_VAR[] = 'lihat_peserta_kelompok';
$EW_USER_LEVEL_TABLE_NAME[] = 'tahap1';
$EW_USER_LEVEL_TABLE_VAR[] = 'tahap1';
$EW_USER_LEVEL_TABLE_NAME[] = 'tahap3';
$EW_USER_LEVEL_TABLE_VAR[] = 'tahap3';
$EW_USER_LEVEL_TABLE_NAME[] = 'tahap4';
$EW_USER_LEVEL_TABLE_VAR[] = 'tahap4';
$EW_USER_LEVEL_TABLE_NAME[] = 'tahap5';
$EW_USER_LEVEL_TABLE_VAR[] = 'tahap5';
$EW_USER_LEVEL_TABLE_NAME[] = 'uji';
$EW_USER_LEVEL_TABLE_VAR[] = 'uji';
$EW_USER_LEVEL_TABLE_NAME[] = 'pemilihan_kelas';
$EW_USER_LEVEL_TABLE_VAR[] = 'pemilihan_kelas';
$EW_USER_LEVEL_TABLE_NAME[] = 'view_peserta2';
$EW_USER_LEVEL_TABLE_VAR[] = 'view_peserta2';
$EW_USER_LEVEL_TABLE_NAME[] = 'st_peserta2';
$EW_USER_LEVEL_TABLE_VAR[] = 'st_peserta2';
$EW_USER_LEVEL_TABLE_NAME[] = 'Report1';
$EW_USER_LEVEL_TABLE_VAR[] = 'Report1';
$EW_USER_LEVEL_TABLE_CAPTION = array_fill(0, 51, ''); // Blank, use $Language object. For compatibility with PHP Report Maker 3 only.
...
// User table filters
define("EW_USER_TABLE", "`pengguna`",  TRUE);
define("EW_USER_NAME_FILTER", "(`username` = '%u')",  TRUE);
define("EW_USER_ID_FILTER", "(`username` = '%u')",  TRUE);
