...
//
// Table class for saldo_rugilaba
//
class csaldo_rugilaba {
	var $TableVar = 'saldo_rugilaba';
	...
	//
	function csaldo_rugilaba() {
		global $Language;
		$this->AllowAddDeleteRow = ew_AllowAddDeleteRow(); // Allow add/delete row

		// norek
		$this->norek = new cField('saldo_rugilaba', 'saldo_rugilaba', 'x_norek', 'norek', '`norek`', 200, -1, FALSE, '`norek`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['norek'] =& $this->norek;

		// keterangan
		$this->keterangan = new cField('saldo_rugilaba', 'saldo_rugilaba', 'x_keterangan', 'keterangan', '`keterangan`', 200, -1, FALSE, '`keterangan`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['keterangan'] =& $this->keterangan;

		// tanggal
		$this->tanggal = new cField('saldo_rugilaba', 'saldo_rugilaba', 'x_tanggal', 'tanggal', '`tanggal`', 200, -1, FALSE, '`tanggal`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['tanggal'] =& $this->tanggal;

		// debet
		$this->debet = new cField('saldo_rugilaba', 'saldo_rugilaba', 'x_debet', 'debet', '`debet`', 3, -1, FALSE, '`debet`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->debet->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['debet'] =& $this->debet;

		// kredit
		$this->kredit = new cField('saldo_rugilaba', 'saldo_rugilaba', 'x_kredit', 'kredit', '`kredit`', 5, -1, FALSE, '`kredit`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function HighlightName() {
		return "saldo_rugilaba_Highlight";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `saldo_rugilaba` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `saldo_rugilaba` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `saldo_rugilaba` WHERE ";
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("saldo_rugilabaview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "saldo_rugilabaadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("saldo_rugilabaedit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("saldo_rugilabaadd.php", $this->UrlParm($parm));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("saldo_rugilabadelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=saldo_rugilaba" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
