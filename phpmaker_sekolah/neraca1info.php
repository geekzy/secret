...
//
// Table class for neraca1
//
class cneraca1 {
	var $TableVar = 'neraca1';
	...
	function cneraca1() {
		...
		// Norek
		$this->Norek = new cField('neraca1', 'neraca1', 'x_Norek', 'Norek', '`Norek`', 200, -1, FALSE, '`Norek`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Norek'] =& $this->Norek;

		// Keterangan
		$this->Keterangan = new cField('neraca1', 'neraca1', 'x_Keterangan', 'Keterangan', '`Keterangan`', 200, -1, FALSE, '`Keterangan`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Keterangan'] =& $this->Keterangan;

		// saldo_debet
		$this->saldo_debet = new cField('neraca1', 'neraca1', 'x_saldo_debet', 'saldo_debet', '`saldo_debet`', 5, -1, FALSE, '`saldo_debet`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->saldo_debet->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['saldo_debet'] =& $this->saldo_debet;

		// saldo_kredit
		$this->saldo_kredit = new cField('neraca1', 'neraca1', 'x_saldo_kredit', 'saldo_kredit', '`saldo_kredit`', 5, -1, FALSE, '`saldo_kredit`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->saldo_kredit->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['saldo_kredit'] =& $this->saldo_kredit;

		// tanggal
		$this->tanggal = new cField('neraca1', 'neraca1', 'x_tanggal', 'tanggal', '`tanggal`', 135, 7, FALSE, '`tanggal`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `neraca1` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `neraca1` SET ";
		foreach ($rs as $name => $value) {
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("neraca1view.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "neraca1add.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("neraca1edit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("neraca1add.php", $this->UrlParm($parm));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("neraca1delete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=neraca1" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
   ...
   // Common render codes
		...
		$this->saldo_debet->ViewValue = ew_FormatNumber($this->saldo_debet->ViewValue, 0, -2, -2, -2);
