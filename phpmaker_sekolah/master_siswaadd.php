...
// Create page object
$master_siswa_add = new cmaster_siswa_add();
$Page =& $master_siswa_add;

// Page init
$master_siswa_add->Page_Init();

// Page main
$master_siswa_add->Page_Main();
?>
...
// Create page object
var master_siswa_add = new ew_Page("master_siswa_add");

// page properties
master_siswa_add.PageID = "add"; // page ID
master_siswa_add.FormID = "fmaster_siswaadd"; // form ID
var EW_PAGE_ID = master_siswa_add.PageID; // for backward compatibility

// extend page with ValidateForm function
master_siswa_add.ValidateForm = function(fobj) {
...
master_siswa_add.Form_CustomValidate =  
 function(fobj) { // DO NOT CHANGE THIS LINE!

 	// Your custom validation code here, return false if invalid. 
 	return true;
 }
master_siswa_add.SelectAllKey = function(elem) {
	ew_SelectAll(elem);
	ew_ClickAll(elem);
}
<?php if (EW_CLIENT_VALIDATE) { ?>
master_siswa_add.ValidateRequired = true; // uses JavaScript validation
<?php } else { ?>
master_siswa_add.ValidateRequired = false; // no JavaScript validation
<?php } ?>

// multi page properties
master_siswa_add.MultiPage = new ew_MultiPage();
master_siswa_add.MultiPage.AddElement("x_no_absen", 1);
master_siswa_add.MultiPage.AddElement("x_A_nama_Lengkap", 1);
master_siswa_add.MultiPage.AddElement("x_A_nama_panggilan", 1);
master_siswa_add.MultiPage.AddElement("x_A_jenis_kelamin", 1);
master_siswa_add.MultiPage.AddElement("x_A_tempat_lahir", 1);
master_siswa_add.MultiPage.AddElement("x_A_tanggal_lahir", 1);
master_siswa_add.MultiPage.AddElement("x_A_agama", 1);
master_siswa_add.MultiPage.AddElement("x_A_kewarganegaraan", 1);
master_siswa_add.MultiPage.AddElement("x_A_anak_keberapa", 1);
master_siswa_add.MultiPage.AddElement("x_A_jumlah_saudara_kandung", 1);
master_siswa_add.MultiPage.AddElement("x_A_jumlah_saudara_tiri", 1);
master_siswa_add.MultiPage.AddElement("x_A_jumlah_saudara_angkat", 1);
master_siswa_add.MultiPage.AddElement("x_A_status_yatim", 1);
master_siswa_add.MultiPage.AddElement("x_A_bahasa", 1);
master_siswa_add.MultiPage.AddElement("x_B_alamat", 2);
master_siswa_add.MultiPage.AddElement("x_B_telepon_rumah", 2);
master_siswa_add.MultiPage.AddElement("x_B_tinggal", 2);
master_siswa_add.MultiPage.AddElement("x_B_jarak", 2);
master_siswa_add.MultiPage.AddElement("x_B_hp", 2);
master_siswa_add.MultiPage.AddElement("x_C_golongan_darah", 3);
master_siswa_add.MultiPage.AddElement("x_C_penyakit", 3);
master_siswa_add.MultiPage.AddElement("x_C_jasmani", 3);
master_siswa_add.MultiPage.AddElement("x_C_tinggi", 3);
master_siswa_add.MultiPage.AddElement("x_C_berat", 3);
master_siswa_add.MultiPage.AddElement("x_D_tamatan_dari", 4);
master_siswa_add.MultiPage.AddElement("x_D_sttb", 4);
master_siswa_add.MultiPage.AddElement("x_D_tanggal_sttb", 4);
master_siswa_add.MultiPage.AddElement("x_D_danum", 4);
master_siswa_add.MultiPage.AddElement("x_D_tanggal_danum", 4);
master_siswa_add.MultiPage.AddElement("x_D_lama_belajar", 4);
master_siswa_add.MultiPage.AddElement("x_D_dari_sekolah", 4);
master_siswa_add.MultiPage.AddElement("x_D_alasan", 4);
master_siswa_add.MultiPage.AddElement("x_D_kelas", 4);
master_siswa_add.MultiPage.AddElement("x_D_kelompok", 4);
master_siswa_add.MultiPage.AddElement("x_D_tanggal", 4);
master_siswa_add.MultiPage.AddElement("x_D_saat_ini_kelas", 4);
master_siswa_add.MultiPage.AddElement("x_D_saat_ini_kelompok", 4);
master_siswa_add.MultiPage.AddElement("x_D_no_psb", 4);
master_siswa_add.MultiPage.AddElement("x_D_nilai_danum_sd", 4);
master_siswa_add.MultiPage.AddElement("x_D_jumlah_pelajaran_danum", 4);
master_siswa_add.MultiPage.AddElement("x_D_nilai_ujian_psb", 4);
master_siswa_add.MultiPage.AddElement("x_D_tahun_psb", 4);
master_siswa_add.MultiPage.AddElement("x_D_diterima", 4);
master_siswa_add.MultiPage.AddElement("x_D_spp", 4);
master_siswa_add.MultiPage.AddElement("x_D_spp_potongan", 4);
master_siswa_add.MultiPage.AddElement("x_D_status_lama_baru", 5);
master_siswa_add.MultiPage.AddElement("x_E_nama_ayah", 5);
master_siswa_add.MultiPage.AddElement("x_E_tempat_lahir", 5);
master_siswa_add.MultiPage.AddElement("x_E_tanggal_lahir", 5);
master_siswa_add.MultiPage.AddElement("x_E_agama", 5);
master_siswa_add.MultiPage.AddElement("x_E_kewarganegaraan", 5);
master_siswa_add.MultiPage.AddElement("x_E_pendidikan", 5);
master_siswa_add.MultiPage.AddElement("x_E_pekerjaan", 5);
master_siswa_add.MultiPage.AddElement("x_E_pengeluaran", 5);
master_siswa_add.MultiPage.AddElement("x_E_alamat", 5);
master_siswa_add.MultiPage.AddElement("x_E_telepon", 5);
master_siswa_add.MultiPage.AddElement("x_E_hp", 5);
master_siswa_add.MultiPage.AddElement("x_E_hidup", 5);
master_siswa_add.MultiPage.AddElement("x_F_nama_ibu", 6);
master_siswa_add.MultiPage.AddElement("x_F_tempat_lahir", 6);
master_siswa_add.MultiPage.AddElement("x_F_tanggal_lahir", 6);
master_siswa_add.MultiPage.AddElement("x_F_agama", 6);
master_siswa_add.MultiPage.AddElement("x_F_kewarganegaraan", 6);
master_siswa_add.MultiPage.AddElement("x_F_pendidikan", 6);
master_siswa_add.MultiPage.AddElement("x_F_pekerjaan", 6);
master_siswa_add.MultiPage.AddElement("x_F_pengeluaran", 6);
master_siswa_add.MultiPage.AddElement("x_F_alamat", 6);
master_siswa_add.MultiPage.AddElement("x_F_telepon", 6);
master_siswa_add.MultiPage.AddElement("x_F_hp", 6);
master_siswa_add.MultiPage.AddElement("x_F_hidup", 6);
master_siswa_add.MultiPage.AddElement("x_G_nama_wali", 7);
master_siswa_add.MultiPage.AddElement("x_G_tempat_lahir", 7);
master_siswa_add.MultiPage.AddElement("x_G_tanggal_lahir", 7);
master_siswa_add.MultiPage.AddElement("x_G_agama", 7);
master_siswa_add.MultiPage.AddElement("x_G_kewarganegaraan", 7);
master_siswa_add.MultiPage.AddElement("x_G_pendidikan", 7);
master_siswa_add.MultiPage.AddElement("x_G_pekerjaan", 7);
master_siswa_add.MultiPage.AddElement("x_G_pengeluaran", 7);
master_siswa_add.MultiPage.AddElement("x_G_alamat", 7);
master_siswa_add.MultiPage.AddElement("x_G_telepon", 7);
master_siswa_add.MultiPage.AddElement("x_G_hp", 7);
master_siswa_add.MultiPage.AddElement("x_H_kesenian", 8);
master_siswa_add.MultiPage.AddElement("x_H_olahraga", 8);
master_siswa_add.MultiPage.AddElement("x_H_kemasyarakatan", 8);
master_siswa_add.MultiPage.AddElement("x_H_lainlain", 8);
master_siswa_add.MultiPage.AddElement("x_I_tanggal_meninggalkan", 9);
master_siswa_add.MultiPage.AddElement("x_I_alasan", 9);
master_siswa_add.MultiPage.AddElement("x_I_tanggal_lulus", 9);
master_siswa_add.MultiPage.AddElement("x_I_sttb", 9);
master_siswa_add.MultiPage.AddElement("x_I_danum", 9);
master_siswa_add.MultiPage.AddElement("x_I_nilai_danum_smp", 9);
master_siswa_add.MultiPage.AddElement("x_I_tahun1", 9);
master_siswa_add.MultiPage.AddElement("x_I_tahun2", 9);
master_siswa_add.MultiPage.AddElement("x_I_tahun3", 9);
master_siswa_add.MultiPage.AddElement("x_I_tk1", 9);
master_siswa_add.MultiPage.AddElement("x_I_tk2", 9);
master_siswa_add.MultiPage.AddElement("x_I_tk3", 9);
master_siswa_add.MultiPage.AddElement("x_I_dari1", 9);
master_siswa_add.MultiPage.AddElement("x_I_dari2", 9);
master_siswa_add.MultiPage.AddElement("x_I_dari3", 9);
master_siswa_add.MultiPage.AddElement("x_J_melanjutkan", 10);
master_siswa_add.MultiPage.AddElement("x_J_tanggal_bekerja", 10);
master_siswa_add.MultiPage.AddElement("x_J_nama_perusahaan", 10);
master_siswa_add.MultiPage.AddElement("x_J_penghasilan", 10);
master_siswa_add.MultiPage.AddElement("x_apakah_valid", 1);
...
<p class="phpmaker ewTitle"><?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $master_siswa->TableCaption() ?></p>
<p class="phpmaker"><a href="<?php echo $master_siswa->getReturnUrl() ?>"><?php echo $Language->Phrase("GoBack") ?></a></p>
<?php $master_siswa_add->ShowPageHeader(); ?>
<?php
$master_siswa_add->ShowMessage();
?>
<form name="fmaster_siswaadd" id="fmaster_siswaadd" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return master_siswa_add.ValidateForm(this);">
<p>
<input type="hidden" name="t" id="t" value="master_siswa">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" cellpadding="0"><tr><td>
<div id="master_siswa_add" class="yui-navset">
	<ul class="yui-nav">
...
<?php
$master_siswa_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script language="JavaScript" type="text/javascript">
...
<?php
$master_siswa_add->Page_Terminate();
?>
<?php
...
class cmaster_siswa_add {
	...
	// Page object name
	var $PageObjName = 'master_siswa_add';
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			$master_siswa->CurrentAction = $_POST["a_add"]; // Get form action
			$this->CopyRecord = $this->LoadOldRecord(); // Load old recordset
			$this->LoadFormValues(); // Load form values

			// Validate form
			if (!$this->ValidateForm()) {
				$master_siswa->CurrentAction = "I"; // Form error, reset action
			...
			if (@$_GET["kode_otomatis"] != "") {
				...
				$master_siswa->setKey("kode_otomatis", $master_siswa->kode_otomatis->CurrentValue); // Set up key
			} else {
				$master_siswa->setKey("kode_otomatis", ""); // Clear key
				$this->CopyRecord = FALSE;
			}
			if ($this->CopyRecord) {
				$master_siswa->CurrentAction = "C"; // Copy record
			} else {
				$master_siswa->CurrentAction = "I"; // Display blank record
		...
		switch ($master_siswa->CurrentAction) {
			...
			case "A": // ' Add new record
				$master_siswa->SendEmail = TRUE; // Send email on add success
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					$this->setSuccessMessage($Language->Phrase("AddSuccess")); // Set up success message
					$sReturnUrl = $master_siswa->getReturnUrl();
					if (ew_GetPageName($sReturnUrl) == "master_siswaview.php")
						$sReturnUrl = $master_siswa->ViewUrl(); // View paging, return to view page with keyurl directly
		...
		$master_siswa->RowType = EW_ROWTYPE_ADD;  // Render add type
	...
	function LoadDefaultValues() {
		global $master_siswa;
		$master_siswa->no_absen->CurrentValue = 0;
		$master_siswa->A_nis_nasional->CurrentValue = isi_nis();
		$master_siswa->A_nama_Lengkap->CurrentValue = 0;
		$master_siswa->A_nama_panggilan->CurrentValue = 0;
		$master_siswa->A_jenis_kelamin->CurrentValue = 0;
		$master_siswa->A_tempat_lahir->CurrentValue = 0;
		$master_siswa->A_tanggal_lahir->CurrentValue = ew_CurrentDate();
		$master_siswa->A_agama->CurrentValue = 0;
		$master_siswa->A_kewarganegaraan->CurrentValue = 0;
		$master_siswa->A_anak_keberapa->CurrentValue = 0;
		$master_siswa->A_jumlah_saudara_kandung->CurrentValue = 0;
		$master_siswa->A_jumlah_saudara_tiri->CurrentValue = 0;
		$master_siswa->A_jumlah_saudara_angkat->CurrentValue = 0;
		$master_siswa->A_status_yatim->CurrentValue = 0;
		$master_siswa->A_bahasa->CurrentValue = 0;
		$master_siswa->B_alamat->CurrentValue = 0;
		$master_siswa->B_telepon_rumah->CurrentValue = 0;
		$master_siswa->B_tinggal->CurrentValue = 0;
		$master_siswa->B_jarak->CurrentValue = 0;
		$master_siswa->B_hp->CurrentValue = 0;
		$master_siswa->C_golongan_darah->CurrentValue = 0;
		$master_siswa->C_penyakit->CurrentValue = 0;
		$master_siswa->C_jasmani->CurrentValue = 0;
		$master_siswa->C_tinggi->CurrentValue = 0;
		$master_siswa->C_berat->CurrentValue = 0;
		$master_siswa->D_tamatan_dari->CurrentValue = 0;
		$master_siswa->D_sttb->CurrentValue = 0;
		$master_siswa->D_tanggal_sttb->CurrentValue = ew_CurrentDate();
		$master_siswa->D_danum->CurrentValue = 0;
		$master_siswa->D_tanggal_danum->CurrentValue = ew_CurrentDate();
		$master_siswa->D_lama_belajar->CurrentValue = 0;
		$master_siswa->D_dari_sekolah->CurrentValue = 0;
		$master_siswa->D_alasan->CurrentValue = 0;
		$master_siswa->D_kelas->CurrentValue = 0;
		$master_siswa->D_kelompok->CurrentValue = 0;
		$master_siswa->D_tanggal->CurrentValue = ew_CurrentDate();
		$master_siswa->D_saat_ini_tingkat->CurrentValue = $_SESSION['kode_otomatis_tingkat'];
		$master_siswa->D_saat_ini_kelas->CurrentValue = 0;
		$master_siswa->D_saat_ini_kelompok->CurrentValue = 0;
		$master_siswa->D_no_psb->CurrentValue = 0;
		$master_siswa->D_nilai_danum_sd->CurrentValue = 0;
		$master_siswa->D_jumlah_pelajaran_danum->CurrentValue = 0;
		$master_siswa->D_nilai_ujian_psb->CurrentValue = 0;
		$master_siswa->D_tahun_psb->CurrentValue = 0;
		$master_siswa->D_diterima->CurrentValue = 0;
		$master_siswa->D_spp->CurrentValue = 0;
		$master_siswa->D_spp_potongan->CurrentValue = 0;
		$master_siswa->D_status_lama_baru->CurrentValue = 0;
		$master_siswa->E_nama_ayah->CurrentValue = 0;
		$master_siswa->E_tempat_lahir->CurrentValue = 0;
		$master_siswa->E_tanggal_lahir->CurrentValue = ew_CurrentDate();
		$master_siswa->E_agama->CurrentValue = 0;
		$master_siswa->E_kewarganegaraan->CurrentValue = 0;
		$master_siswa->E_pendidikan->CurrentValue = 0;
		$master_siswa->E_pekerjaan->CurrentValue = 0;
		$master_siswa->E_pengeluaran->CurrentValue = 0;
		$master_siswa->E_alamat->CurrentValue = 0;
		$master_siswa->E_telepon->CurrentValue = 0;
		$master_siswa->E_hp->CurrentValue = 0;
		$master_siswa->E_hidup->CurrentValue = 0;
		$master_siswa->F_nama_ibu->CurrentValue = 0;
		$master_siswa->F_tempat_lahir->CurrentValue = 0;
		$master_siswa->F_tanggal_lahir->CurrentValue = ew_CurrentDate();
		$master_siswa->F_agama->CurrentValue = 0;
		$master_siswa->F_kewarganegaraan->CurrentValue = 0;
		$master_siswa->F_pendidikan->CurrentValue = 0;
		$master_siswa->F_pekerjaan->CurrentValue = 0;
		$master_siswa->F_pengeluaran->CurrentValue = 0;
		$master_siswa->F_alamat->CurrentValue = 0;
		$master_siswa->F_telepon->CurrentValue = 0;
		$master_siswa->F_hp->CurrentValue = 0;
		$master_siswa->F_hidup->CurrentValue = 0;
		$master_siswa->G_nama_wali->CurrentValue = 0;
		$master_siswa->G_tempat_lahir->CurrentValue = 0;
		$master_siswa->G_tanggal_lahir->CurrentValue = ew_CurrentDate();
		$master_siswa->G_agama->CurrentValue = 0;
		$master_siswa->G_kewarganegaraan->CurrentValue = 0;
		$master_siswa->G_pendidikan->CurrentValue = 0;
		$master_siswa->G_pekerjaan->CurrentValue = 0;
		$master_siswa->G_pengeluaran->CurrentValue = 0;
		$master_siswa->G_alamat->CurrentValue = 0;
		$master_siswa->G_telepon->CurrentValue = 0;
		$master_siswa->G_hp->CurrentValue = 0;
		$master_siswa->H_kesenian->CurrentValue = 0;
		$master_siswa->H_olahraga->CurrentValue = 0;
		$master_siswa->H_kemasyarakatan->CurrentValue = 0;
		$master_siswa->H_lainlain->CurrentValue = 0;
		$master_siswa->I_tanggal_meninggalkan->CurrentValue = ew_CurrentDate();
		$master_siswa->I_alasan->CurrentValue = 0;
		$master_siswa->I_tanggal_lulus->CurrentValue = ew_CurrentDate();
		$master_siswa->I_sttb->CurrentValue = 0;
		$master_siswa->I_danum->CurrentValue = 0;
		$master_siswa->I_nilai_danum_smp->CurrentValue = 0;
		$master_siswa->I_tahun1->CurrentValue = 0;
		$master_siswa->I_tahun2->CurrentValue = 0;
		$master_siswa->I_tahun3->CurrentValue = 0;
		$master_siswa->I_tk1->CurrentValue = 0;
		$master_siswa->I_tk2->CurrentValue = 0;
		$master_siswa->I_tk3->CurrentValue = 0;
		$master_siswa->I_dari1->CurrentValue = 0;
		$master_siswa->I_dari2->CurrentValue = 0;
		$master_siswa->I_dari3->CurrentValue = 0;
		$master_siswa->J_melanjutkan->CurrentValue = 0;
		$master_siswa->J_tanggal_bekerja->CurrentValue = ew_CurrentDate();
		$master_siswa->J_nama_perusahaan->CurrentValue = 0;
		$master_siswa->J_penghasilan->CurrentValue = 0;
		$master_siswa->kode_otomatis->CurrentValue = unik();
		$master_siswa->apakah_valid->CurrentValue = "y";
	}
	...
	function RenderRow() {
		...
		} elseif ($master_siswa->RowType == EW_ROWTYPE_ADD) { // Add row
	...
	function AddRow($rsold = NULL) {
		...
		if ($master_siswa->kode_otomatis->CurrentValue == "" && $master_siswa->kode_otomatis->getSessionValue() == "") {
		...
		$sFilter = $master_siswa->KeyFilter();
		if ($bCheckKey) {
			$rsChk = $master_siswa->LoadRs($sFilter);
			if ($rsChk && !$rsChk->EOF) {
		...
		if ($master_siswa->A_nis_nasional->CurrentValue <> "") { // Check field with unique index
			$sFilter = "(A_nis_nasional = '" . ew_AdjustSql($master_siswa->A_nis_nasional->CurrentValue) . "')";
			$rsChk = $master_siswa->LoadRs($sFilter);
			if ($rsChk && !$rsChk->EOF) {
		...
		if ($master_siswa->kode_otomatis->CurrentValue <> "") { // Check field with unique index
			$sFilter = "(kode_otomatis = '" . ew_AdjustSql($master_siswa->kode_otomatis->CurrentValue) . "')";
			$rsChk = $master_siswa->LoadRs($sFilter);
			if ($rsChk && !$rsChk->EOF) {
				$sIdxErrMsg = str_replace("%f", 'kode_otomatis', $Language->Phrase("DupIndex"));
				$sIdxErrMsg = str_replace("%v", $master_siswa->kode_otomatis->CurrentValue, $sIdxErrMsg);
				$this->setFailureMessage($sIdxErrMsg);
				$rsChk->Close();
				return FALSE;
			}
		...
		// no_absen
		$master_siswa->no_absen->SetDbValueDef($rsnew, $master_siswa->no_absen->CurrentValue, 0, FALSE);

		// A_nis_nasional
		$master_siswa->A_nis_nasional->SetDbValueDef($rsnew, $master_siswa->A_nis_nasional->CurrentValue, "", FALSE);

		// A_nama_Lengkap
		$master_siswa->A_nama_Lengkap->SetDbValueDef($rsnew, $master_siswa->A_nama_Lengkap->CurrentValue, "", FALSE);

		// A_nama_panggilan
		$master_siswa->A_nama_panggilan->SetDbValueDef($rsnew, $master_siswa->A_nama_panggilan->CurrentValue, "", FALSE);

		// A_jenis_kelamin
		$master_siswa->A_jenis_kelamin->SetDbValueDef($rsnew, $master_siswa->A_jenis_kelamin->CurrentValue, "", FALSE);

		// A_tempat_lahir
		$master_siswa->A_tempat_lahir->SetDbValueDef($rsnew, $master_siswa->A_tempat_lahir->CurrentValue, "", FALSE);

		// A_tanggal_lahir
		$master_siswa->A_tanggal_lahir->SetDbValueDef($rsnew, ew_UnFormatDateTime($master_siswa->A_tanggal_lahir->CurrentValue, 7), ew_CurrentDate(), FALSE);

		// A_agama
		$master_siswa->A_agama->SetDbValueDef($rsnew, $master_siswa->A_agama->CurrentValue, "", FALSE);

		// A_kewarganegaraan
		$master_siswa->A_kewarganegaraan->SetDbValueDef($rsnew, $master_siswa->A_kewarganegaraan->CurrentValue, "", FALSE);

		// A_anak_keberapa
		$master_siswa->A_anak_keberapa->SetDbValueDef($rsnew, $master_siswa->A_anak_keberapa->CurrentValue, 0, FALSE);

		// A_jumlah_saudara_kandung
		$master_siswa->A_jumlah_saudara_kandung->SetDbValueDef($rsnew, $master_siswa->A_jumlah_saudara_kandung->CurrentValue, 0, FALSE);

		// A_jumlah_saudara_tiri
		$master_siswa->A_jumlah_saudara_tiri->SetDbValueDef($rsnew, $master_siswa->A_jumlah_saudara_tiri->CurrentValue, 0, FALSE);

		// A_jumlah_saudara_angkat
		$master_siswa->A_jumlah_saudara_angkat->SetDbValueDef($rsnew, $master_siswa->A_jumlah_saudara_angkat->CurrentValue, 0, FALSE);

		// A_status_yatim
		$master_siswa->A_status_yatim->SetDbValueDef($rsnew, $master_siswa->A_status_yatim->CurrentValue, "", FALSE);

		// A_bahasa
		$master_siswa->A_bahasa->SetDbValueDef($rsnew, $master_siswa->A_bahasa->CurrentValue, "", FALSE);

		// B_alamat
		$master_siswa->B_alamat->SetDbValueDef($rsnew, $master_siswa->B_alamat->CurrentValue, "", FALSE);

		// B_telepon_rumah
		$master_siswa->B_telepon_rumah->SetDbValueDef($rsnew, $master_siswa->B_telepon_rumah->CurrentValue, "", FALSE);

		// B_tinggal
		$master_siswa->B_tinggal->SetDbValueDef($rsnew, $master_siswa->B_tinggal->CurrentValue, "", FALSE);

		// B_jarak
		$master_siswa->B_jarak->SetDbValueDef($rsnew, $master_siswa->B_jarak->CurrentValue, 0, FALSE);

		// B_hp
		$master_siswa->B_hp->SetDbValueDef($rsnew, $master_siswa->B_hp->CurrentValue, "", FALSE);

		// C_golongan_darah
		$master_siswa->C_golongan_darah->SetDbValueDef($rsnew, $master_siswa->C_golongan_darah->CurrentValue, "", FALSE);

		// C_penyakit
		$master_siswa->C_penyakit->SetDbValueDef($rsnew, $master_siswa->C_penyakit->CurrentValue, "", FALSE);

		// C_jasmani
		$master_siswa->C_jasmani->SetDbValueDef($rsnew, $master_siswa->C_jasmani->CurrentValue, "", FALSE);

		// C_tinggi
		$master_siswa->C_tinggi->SetDbValueDef($rsnew, $master_siswa->C_tinggi->CurrentValue, 0, FALSE);

		// C_berat
		$master_siswa->C_berat->SetDbValueDef($rsnew, $master_siswa->C_berat->CurrentValue, 0, FALSE);

		// D_tamatan_dari
		$master_siswa->D_tamatan_dari->SetDbValueDef($rsnew, $master_siswa->D_tamatan_dari->CurrentValue, "", FALSE);

		// D_sttb
		$master_siswa->D_sttb->SetDbValueDef($rsnew, $master_siswa->D_sttb->CurrentValue, "", FALSE);

		// D_tanggal_sttb
		$master_siswa->D_tanggal_sttb->SetDbValueDef($rsnew, ew_UnFormatDateTime($master_siswa->D_tanggal_sttb->CurrentValue, 7), ew_CurrentDate(), FALSE);

		// D_danum
		$master_siswa->D_danum->SetDbValueDef($rsnew, $master_siswa->D_danum->CurrentValue, "", FALSE);

		// D_tanggal_danum
		$master_siswa->D_tanggal_danum->SetDbValueDef($rsnew, ew_UnFormatDateTime($master_siswa->D_tanggal_danum->CurrentValue, 7), ew_CurrentDate(), FALSE);

		// D_lama_belajar
		$master_siswa->D_lama_belajar->SetDbValueDef($rsnew, $master_siswa->D_lama_belajar->CurrentValue, 0, FALSE);

		// D_dari_sekolah
		$master_siswa->D_dari_sekolah->SetDbValueDef($rsnew, $master_siswa->D_dari_sekolah->CurrentValue, "", FALSE);

		// D_alasan
		$master_siswa->D_alasan->SetDbValueDef($rsnew, $master_siswa->D_alasan->CurrentValue, "", FALSE);

		// D_kelas
		$master_siswa->D_kelas->SetDbValueDef($rsnew, $master_siswa->D_kelas->CurrentValue, "", FALSE);

		// D_kelompok
		$master_siswa->D_kelompok->SetDbValueDef($rsnew, $master_siswa->D_kelompok->CurrentValue, "", FALSE);

		// D_tanggal
		$master_siswa->D_tanggal->SetDbValueDef($rsnew, ew_UnFormatDateTime($master_siswa->D_tanggal->CurrentValue, 7), ew_CurrentDate(), FALSE);

		// D_saat_ini_tingkat
		$master_siswa->D_saat_ini_tingkat->SetDbValueDef($rsnew, $master_siswa->D_saat_ini_tingkat->CurrentValue, "", FALSE);

		// D_saat_ini_kelas
		$master_siswa->D_saat_ini_kelas->SetDbValueDef($rsnew, $master_siswa->D_saat_ini_kelas->CurrentValue, "", FALSE);

		// D_saat_ini_kelompok
		$master_siswa->D_saat_ini_kelompok->SetDbValueDef($rsnew, $master_siswa->D_saat_ini_kelompok->CurrentValue, "", FALSE);

		// D_no_psb
		$master_siswa->D_no_psb->SetDbValueDef($rsnew, $master_siswa->D_no_psb->CurrentValue, "", FALSE);

		// D_nilai_danum_sd
		$master_siswa->D_nilai_danum_sd->SetDbValueDef($rsnew, $master_siswa->D_nilai_danum_sd->CurrentValue, 0, FALSE);

		// D_jumlah_pelajaran_danum
		$master_siswa->D_jumlah_pelajaran_danum->SetDbValueDef($rsnew, $master_siswa->D_jumlah_pelajaran_danum->CurrentValue, 0, FALSE);

		// D_nilai_ujian_psb
		$master_siswa->D_nilai_ujian_psb->SetDbValueDef($rsnew, $master_siswa->D_nilai_ujian_psb->CurrentValue, 0, FALSE);

		// D_tahun_psb
		$master_siswa->D_tahun_psb->SetDbValueDef($rsnew, $master_siswa->D_tahun_psb->CurrentValue, "", FALSE);

		// D_diterima
		$master_siswa->D_diterima->SetDbValueDef($rsnew, $master_siswa->D_diterima->CurrentValue, "", FALSE);

		// D_spp
		$master_siswa->D_spp->SetDbValueDef($rsnew, $master_siswa->D_spp->CurrentValue, 0, FALSE);

		// D_spp_potongan
		$master_siswa->D_spp_potongan->SetDbValueDef($rsnew, $master_siswa->D_spp_potongan->CurrentValue, 0, FALSE);

		// D_status_lama_baru
		$master_siswa->D_status_lama_baru->SetDbValueDef($rsnew, $master_siswa->D_status_lama_baru->CurrentValue, "", FALSE);

		// E_nama_ayah
		$master_siswa->E_nama_ayah->SetDbValueDef($rsnew, $master_siswa->E_nama_ayah->CurrentValue, "", FALSE);

		// E_tempat_lahir
		$master_siswa->E_tempat_lahir->SetDbValueDef($rsnew, $master_siswa->E_tempat_lahir->CurrentValue, "", FALSE);

		// E_tanggal_lahir
		$master_siswa->E_tanggal_lahir->SetDbValueDef($rsnew, ew_UnFormatDateTime($master_siswa->E_tanggal_lahir->CurrentValue, 7), ew_CurrentDate(), FALSE);

		// E_agama
		$master_siswa->E_agama->SetDbValueDef($rsnew, $master_siswa->E_agama->CurrentValue, "", FALSE);

		// E_kewarganegaraan
		$master_siswa->E_kewarganegaraan->SetDbValueDef($rsnew, $master_siswa->E_kewarganegaraan->CurrentValue, "", FALSE);

		// E_pendidikan
		$master_siswa->E_pendidikan->SetDbValueDef($rsnew, $master_siswa->E_pendidikan->CurrentValue, "", FALSE);

		// E_pekerjaan
		$master_siswa->E_pekerjaan->SetDbValueDef($rsnew, $master_siswa->E_pekerjaan->CurrentValue, "", FALSE);

		// E_pengeluaran
		$master_siswa->E_pengeluaran->SetDbValueDef($rsnew, $master_siswa->E_pengeluaran->CurrentValue, 0, FALSE);

		// E_alamat
		$master_siswa->E_alamat->SetDbValueDef($rsnew, $master_siswa->E_alamat->CurrentValue, "", FALSE);

		// E_telepon
		$master_siswa->E_telepon->SetDbValueDef($rsnew, $master_siswa->E_telepon->CurrentValue, "", FALSE);

		// E_hp
		$master_siswa->E_hp->SetDbValueDef($rsnew, $master_siswa->E_hp->CurrentValue, "", FALSE);

		// E_hidup
		$master_siswa->E_hidup->SetDbValueDef($rsnew, $master_siswa->E_hidup->CurrentValue, "", FALSE);

		// F_nama_ibu
		$master_siswa->F_nama_ibu->SetDbValueDef($rsnew, $master_siswa->F_nama_ibu->CurrentValue, "", FALSE);

		// F_tempat_lahir
		$master_siswa->F_tempat_lahir->SetDbValueDef($rsnew, $master_siswa->F_tempat_lahir->CurrentValue, "", FALSE);

		// F_tanggal_lahir
		$master_siswa->F_tanggal_lahir->SetDbValueDef($rsnew, ew_UnFormatDateTime($master_siswa->F_tanggal_lahir->CurrentValue, 7), ew_CurrentDate(), FALSE);

		// F_agama
		$master_siswa->F_agama->SetDbValueDef($rsnew, $master_siswa->F_agama->CurrentValue, "", FALSE);

		// F_kewarganegaraan
		$master_siswa->F_kewarganegaraan->SetDbValueDef($rsnew, $master_siswa->F_kewarganegaraan->CurrentValue, "", FALSE);

		// F_pendidikan
		$master_siswa->F_pendidikan->SetDbValueDef($rsnew, $master_siswa->F_pendidikan->CurrentValue, "", FALSE);

		// F_pekerjaan
		$master_siswa->F_pekerjaan->SetDbValueDef($rsnew, $master_siswa->F_pekerjaan->CurrentValue, "", FALSE);

		// F_pengeluaran
		$master_siswa->F_pengeluaran->SetDbValueDef($rsnew, $master_siswa->F_pengeluaran->CurrentValue, 0, FALSE);

		// F_alamat
		$master_siswa->F_alamat->SetDbValueDef($rsnew, $master_siswa->F_alamat->CurrentValue, "", FALSE);

		// F_telepon
		$master_siswa->F_telepon->SetDbValueDef($rsnew, $master_siswa->F_telepon->CurrentValue, "", FALSE);

		// F_hp
		$master_siswa->F_hp->SetDbValueDef($rsnew, $master_siswa->F_hp->CurrentValue, "", FALSE);

		// F_hidup
		$master_siswa->F_hidup->SetDbValueDef($rsnew, $master_siswa->F_hidup->CurrentValue, "", FALSE);

		// G_nama_wali
		$master_siswa->G_nama_wali->SetDbValueDef($rsnew, $master_siswa->G_nama_wali->CurrentValue, "", FALSE);

		// G_tempat_lahir
		$master_siswa->G_tempat_lahir->SetDbValueDef($rsnew, $master_siswa->G_tempat_lahir->CurrentValue, "", FALSE);

		// G_tanggal_lahir
		$master_siswa->G_tanggal_lahir->SetDbValueDef($rsnew, ew_UnFormatDateTime($master_siswa->G_tanggal_lahir->CurrentValue, 7), ew_CurrentDate(), FALSE);

		// G_agama
		$master_siswa->G_agama->SetDbValueDef($rsnew, $master_siswa->G_agama->CurrentValue, "", FALSE);

		// G_kewarganegaraan
		$master_siswa->G_kewarganegaraan->SetDbValueDef($rsnew, $master_siswa->G_kewarganegaraan->CurrentValue, "", FALSE);

		// G_pendidikan
		$master_siswa->G_pendidikan->SetDbValueDef($rsnew, $master_siswa->G_pendidikan->CurrentValue, "", FALSE);

		// G_pekerjaan
		$master_siswa->G_pekerjaan->SetDbValueDef($rsnew, $master_siswa->G_pekerjaan->CurrentValue, "", FALSE);

		// G_pengeluaran
		$master_siswa->G_pengeluaran->SetDbValueDef($rsnew, $master_siswa->G_pengeluaran->CurrentValue, 0, FALSE);

		// G_alamat
		$master_siswa->G_alamat->SetDbValueDef($rsnew, $master_siswa->G_alamat->CurrentValue, "", FALSE);

		// G_telepon
		$master_siswa->G_telepon->SetDbValueDef($rsnew, $master_siswa->G_telepon->CurrentValue, "", FALSE);

		// G_hp
		$master_siswa->G_hp->SetDbValueDef($rsnew, $master_siswa->G_hp->CurrentValue, "", FALSE);

		// H_kesenian
		$master_siswa->H_kesenian->SetDbValueDef($rsnew, $master_siswa->H_kesenian->CurrentValue, "", FALSE);

		// H_olahraga
		$master_siswa->H_olahraga->SetDbValueDef($rsnew, $master_siswa->H_olahraga->CurrentValue, "", FALSE);

		// H_kemasyarakatan
		$master_siswa->H_kemasyarakatan->SetDbValueDef($rsnew, $master_siswa->H_kemasyarakatan->CurrentValue, "", FALSE);

		// H_lainlain
		$master_siswa->H_lainlain->SetDbValueDef($rsnew, $master_siswa->H_lainlain->CurrentValue, "", FALSE);

		// I_tanggal_meninggalkan
		$master_siswa->I_tanggal_meninggalkan->SetDbValueDef($rsnew, ew_UnFormatDateTime($master_siswa->I_tanggal_meninggalkan->CurrentValue, 7), ew_CurrentDate(), FALSE);

		// I_alasan
		$master_siswa->I_alasan->SetDbValueDef($rsnew, $master_siswa->I_alasan->CurrentValue, "", FALSE);

		// I_tanggal_lulus
		$master_siswa->I_tanggal_lulus->SetDbValueDef($rsnew, ew_UnFormatDateTime($master_siswa->I_tanggal_lulus->CurrentValue, 7), ew_CurrentDate(), FALSE);

		// I_sttb
		$master_siswa->I_sttb->SetDbValueDef($rsnew, $master_siswa->I_sttb->CurrentValue, "", FALSE);

		// I_danum
		$master_siswa->I_danum->SetDbValueDef($rsnew, $master_siswa->I_danum->CurrentValue, "", FALSE);

		// I_nilai_danum_smp
		$master_siswa->I_nilai_danum_smp->SetDbValueDef($rsnew, $master_siswa->I_nilai_danum_smp->CurrentValue, 0, FALSE);

		// I_tahun1
		$master_siswa->I_tahun1->SetDbValueDef($rsnew, $master_siswa->I_tahun1->CurrentValue, "", FALSE);

		// I_tahun2
		$master_siswa->I_tahun2->SetDbValueDef($rsnew, $master_siswa->I_tahun2->CurrentValue, "", FALSE);

		// I_tahun3
		$master_siswa->I_tahun3->SetDbValueDef($rsnew, $master_siswa->I_tahun3->CurrentValue, "", FALSE);

		// I_tk1
		$master_siswa->I_tk1->SetDbValueDef($rsnew, $master_siswa->I_tk1->CurrentValue, "", FALSE);

		// I_tk2
		$master_siswa->I_tk2->SetDbValueDef($rsnew, $master_siswa->I_tk2->CurrentValue, "", FALSE);

		// I_tk3
		$master_siswa->I_tk3->SetDbValueDef($rsnew, $master_siswa->I_tk3->CurrentValue, "", FALSE);

		// I_dari1
		$master_siswa->I_dari1->SetDbValueDef($rsnew, $master_siswa->I_dari1->CurrentValue, "", FALSE);

		// I_dari2
		$master_siswa->I_dari2->SetDbValueDef($rsnew, $master_siswa->I_dari2->CurrentValue, "", FALSE);

		// I_dari3
		$master_siswa->I_dari3->SetDbValueDef($rsnew, $master_siswa->I_dari3->CurrentValue, "", FALSE);

		// J_melanjutkan
		$master_siswa->J_melanjutkan->SetDbValueDef($rsnew, $master_siswa->J_melanjutkan->CurrentValue, "", FALSE);

		// J_tanggal_bekerja
		$master_siswa->J_tanggal_bekerja->SetDbValueDef($rsnew, ew_UnFormatDateTime($master_siswa->J_tanggal_bekerja->CurrentValue, 7), ew_CurrentDate(), FALSE);

		// J_nama_perusahaan
		$master_siswa->J_nama_perusahaan->SetDbValueDef($rsnew, $master_siswa->J_nama_perusahaan->CurrentValue, "", FALSE);

		// J_penghasilan
		$master_siswa->J_penghasilan->SetDbValueDef($rsnew, $master_siswa->J_penghasilan->CurrentValue, 0, FALSE);

		// kode_otomatis
		$master_siswa->kode_otomatis->SetDbValueDef($rsnew, $master_siswa->kode_otomatis->CurrentValue, "", FALSE);

		// apakah_valid
		$master_siswa->apakah_valid->SetDbValueDef($rsnew, $master_siswa->apakah_valid->CurrentValue, "", strval($master_siswa->apakah_valid->CurrentValue) == "");

		// Call Row Inserting event
		$rs = ($rsold == NULL) ? NULL : $rsold->fields;
		$bInsertRow = $master_siswa->Row_Inserting($rs, $rsnew);
		if ($bInsertRow) {
			$conn->raiseErrorFn = 'ew_ErrorFn';
			$AddRow = $conn->Execute($master_siswa->InsertSQL($rsnew));
			$conn->raiseErrorFn = '';
		} else {
		...
		if ($AddRow) {
			...
			$rs = ($rsold == NULL) ? NULL : $rsold->fields;
			$master_siswa->Row_Inserted($rs, $rsnew);
		}
		return $AddRow;
	}
