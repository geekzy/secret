...
$entri_tanggungan_perkelompok = NULL;

//
// Table class for entri_tanggungan_perkelompok
//
class centri_tanggungan_perkelompok {
	var $TableVar = 'entri_tanggungan_perkelompok';
	...
	//
	function centri_tanggungan_perkelompok() {
		global $Language;
		$this->AllowAddDeleteRow = ew_AllowAddDeleteRow(); // Allow add/delete row

		// tahun
		$this->tahun = new cField('entri_tanggungan_perkelompok', 'entri_tanggungan_perkelompok', 'x_tahun', 'tahun', '`tahun`', 200, -1, FALSE, '`tahun`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['tahun'] =& $this->tahun;

		// kelas
		$this->kelas = new cField('entri_tanggungan_perkelompok', 'entri_tanggungan_perkelompok', 'x_kelas', 'kelas', '`kelas`', 200, -1, FALSE, '`kelas`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['kelas'] =& $this->kelas;

		// nama_kelas_kelompok
		$this->nama_kelas_kelompok = new cField('entri_tanggungan_perkelompok', 'entri_tanggungan_perkelompok', 'x_nama_kelas_kelompok', 'nama_kelas_kelompok', '`nama_kelas_kelompok`', 200, -1, FALSE, '`nama_kelas_kelompok`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['nama_kelas_kelompok'] =& $this->nama_kelas_kelompok;

		// kode_otomatis
		$this->kode_otomatis = new cField('entri_tanggungan_perkelompok', 'entri_tanggungan_perkelompok', 'x_kode_otomatis', 'kode_otomatis', '`kode_otomatis`', 200, -1, FALSE, '`kode_otomatis`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['kode_otomatis'] =& $this->kode_otomatis;

		// apakah_valid
		$this->apakah_valid = new cField('entri_tanggungan_perkelompok', 'entri_tanggungan_perkelompok', 'x_apakah_valid', 'apakah_valid', '`apakah_valid`', 200, -1, FALSE, '`apakah_valid`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['apakah_valid'] =& $this->apakah_valid;

		// kode_otomatis_tingkat
		$this->kode_otomatis_tingkat = new cField('entri_tanggungan_perkelompok', 'entri_tanggungan_perkelompok', 'x_kode_otomatis_tingkat', 'kode_otomatis_tingkat', '`kode_otomatis_tingkat`', 200, -1, FALSE, '`kode_otomatis_tingkat`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function HighlightName() {
		return "entri_tanggungan_perkelompok_Highlight";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "entri_tanggungan_perkelompoklist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("entri_tanggungan_perkelompokview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "entri_tanggungan_perkelompokadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("entri_tanggungan_perkelompokedit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("entri_tanggungan_perkelompokadd.php", $this->UrlParm($parm));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("entri_tanggungan_perkelompokdelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=entri_tanggungan_perkelompok" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
